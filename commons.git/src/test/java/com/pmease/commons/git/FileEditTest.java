...
public class FileEditTest extends AbstractGitTest {
	...
	public void testRemoveFile() throws IOException {
		...
		try (Repository repo = new FileRepository(new File(git.repoDir(), ".git"))) {
			...
			FileEdit edit = new FileEdit("/server/src/com/example/a//a.java", null, null);
	...
	public void testRemoveNonExistentFile() throws IOException {
		...
		try (Repository repo = new FileRepository(new File(git.repoDir(), ".git"))) {
			...
			FileEdit edit = new FileEdit("/server/src/com/example/c//c.java", null, null);
			try {
	...
	public void testRenameFile() throws IOException {
		...
		try (Repository repo = new FileRepository(new File(git.repoDir(), ".git"))) {
			...
			FileEdit edit = new FileEdit("server/src/com/example/a/a.java", "client/c.java", "a".getBytes());
	...
	public void shouldFailIfOldPathIsTreeWhenRename() throws IOException {
		...
		try (Repository repo = new FileRepository(new File(git.repoDir(), ".git"))) {
			...
			FileEdit edit = new FileEdit("server/src/com/example/a", "client/c.java", "a".getBytes());
			try {
	...
	public void shouldFailIfNewPathIsNotUnderTreeWhenRename() throws IOException {
		...
		try (Repository repo = new FileRepository(new File(git.repoDir(), ".git"))) {
			...
			FileEdit edit = new FileEdit("server/src/com/example/a/a.java", "client/a.java/a.java", "a".getBytes());
			try {
				edit.commit(repo, refName, oldCommitId, oldCommitId, person, "test rename tree");
	...
	public void testAddFile() throws IOException {
		...
		try (Repository repo = new FileRepository(new File(git.repoDir(), ".git"))) {
			...
			FileEdit edit = new FileEdit(null, "/server/src/com/example/c/c.java", "c".getBytes());
			...
			edit = new FileEdit(null, "/common/common.java", "common".getBytes());
	...
	public void testAddExistFile() throws IOException {
		...
		try (Repository repo = new FileRepository(new File(git.repoDir(), ".git"))) {
			...
			FileEdit edit = new FileEdit(null, "client/a.java", "a".getBytes());
			try {
				edit.commit(repo, refName, oldCommitId, oldCommitId, person, "test rename tree");
