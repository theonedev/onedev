...
public class AffinalRepoChoiceProvider extends ListChoiceProvider<Repository> {

	private IModel<Repository> repoModel;
	
	private IModel<List<Repository>> affinalReposModel;

	public AffinalRepoChoiceProvider(IModel<Repository> repoModel) {
		super(Constants.DEFAULT_PAGE_SIZE);
		
		affinalReposModel = new AffinalRepositoriesModel(repoModel);
	}
