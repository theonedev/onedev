package com.pmease.gitplex.web.common.wicket.form.passwordfield;
...
public class PasswordFieldElement extends
		AbstractInputElement<String, PasswordFieldElement> {
	...
	protected PasswordTextField newTextInput(String id) {
		...
		if (size > 0) {
			passwordField.add(AttributeModifier.replace("size",
					String.valueOf(size)));
		}
