...
import com.pmease.gitplex.web.common.wicket.component.tab.AbstractPageTab;
import com.pmease.gitplex.web.page.repository.RepositoryPage;
import com.pmease.gitplex.web.page.repository.RepositoryCategoryPageLink;
...
public class RepositoryPageTab extends AbstractPageTab {
	...
	protected Repository getRepository() {
		return GitPlex.getInstance(Dao.class).load(Repository.class, SessionData.get().getRepositoryId());
	}
