...
public class PermissionSettingPage extends RepositoryPage {
	...
	private Component newTeamsTable() {
		...
		IColumn<Team, String> column = new AbstractColumn<Team, String>(Model.of("Team")) {
			...
			public void populateItem(Item<ICellPopulator<Team>> cellItem,
				...
				Fragment frag = new Fragment(componentId, "namefrag", PermissionSettingPage.this);
		...
		columns.add(new HeaderlessColumn<Team, String>() {
			...
			public void populateItem(Item<ICellPopulator<Team>> cellItem,
				...
				Fragment frag = new Fragment(componentId, "operationfrag", PermissionSettingPage.this);
	...
	private class PermissionColumn extends AbstractColumn<Team, String> {
		...
		public void populateItem(Item<ICellPopulator<Team>> cellItem,
			...
			Fragment frag = new Fragment(componentId, "permissionop", PermissionSettingPage.this);
			cellItem.add(frag);
