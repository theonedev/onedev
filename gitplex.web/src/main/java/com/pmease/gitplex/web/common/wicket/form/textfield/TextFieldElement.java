package com.pmease.gitplex.web.common.wicket.form.textfield;
...
public class TextFieldElement<T> extends
		AbstractInputElement<T, TextFieldElement<T>> {
	...
	protected TextField<T> newTextInput(String id) {
		...
		if (size > 0) {
			textField.add(AttributeModifier.replace("size",
					String.valueOf(size)));
		}
