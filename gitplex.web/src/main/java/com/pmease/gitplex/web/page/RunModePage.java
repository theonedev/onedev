...
public class RunModePage extends CommonPage {
	...
	public void renderHead(IHeaderResponse response) {
		...
		response.render(JavaScriptHeaderItem.forReference(
				new WebjarsJavaScriptResourceReference("codemirror/current/mode/clike/clike.js")));
		response.render(CssHeaderItem.forReference(
				new WebjarsCssResourceReference("codemirror/current/lib/codemirror.css")));

		File file = new File("W:\\commons\\commons.tokenizer\\src\\test\\java\\commons\\tokenizer\\testfiles\\test.scala");
