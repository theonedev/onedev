package com.pmease.gitplex.web.page.account.notification;
...
public class AccountNotificationPage extends AccountPage {

	public AccountNotificationPage(PageParameters params) {
		super(params);
	}
	...
	protected void onInitialize() {
		...
		add(new Link<Void>("deleteSelected") {
			...
			public void onClick() {
				...
				setResponsePage(AccountNotificationPage.class, AccountNotificationPage.paramsOf(getAccount()));
			}
