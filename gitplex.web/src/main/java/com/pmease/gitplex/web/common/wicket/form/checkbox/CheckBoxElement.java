package com.pmease.gitplex.web.common.wicket.form.checkbox;
...
import com.pmease.gitplex.web.common.wicket.form.AbstractInputElement;

public class CheckBoxElement extends
		AbstractInputElement<Boolean, CheckBoxElement> {
	...
	public CheckBoxElement(String id, IModel<Boolean> inputModel,
			IModel<String> description) {
		this(id, "", inputModel, description);
	}

	public CheckBoxElement(String id, String label, IModel<Boolean> inputModel,
			IModel<String> description) {
		super(id, label);
