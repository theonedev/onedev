...
public class RestoreSourceBranch implements RenderableActivity {
	...
	public RestoreSourceBranch(PullRequest request, User user, Date date) {
	...
	public Panel render(String panelId) {
		return new RestoreSourceBranchActivityPanel(panelId, new LoadableDetachableModel<PullRequest>() {
