...
public class ImageBlobResource extends DynamicImageResource {
	...
	private synchronized byte[] internalGetImageData(PageParameters params) {
		...
		final String revision = params.get(RepositoryInfoPage.PARAM_REVISION).toString();
		final String path = params.get(RepositoryInfoPage.PARAM_PATH).toString();
	...
	public Dimension getImageDimension(PageParameters params) {
		String path = params.get(RepositoryInfoPage.PARAM_PATH).toString();
