...
import com.pmease.gitplex.web.page.repository.api.RepositoryPageTab;
import com.pmease.gitplex.web.page.repository.api.RepositoryPageTab.Category;
...
public abstract class RepositoryInfoPage extends RepositoryPage {
	...
	protected String findRevision(PageParameters params) {
		String rev = params.get(RepositoryPage.PARAM_OBJECT_ID).toString();
