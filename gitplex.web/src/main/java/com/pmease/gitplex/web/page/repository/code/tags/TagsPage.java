package com.pmease.gitplex.web.page.repository.code.tags;
...
import com.pmease.gitplex.web.git.command.Tag;
import com.pmease.gitplex.web.git.command.TagForEachRefCommand;
			...
			frag.add(new ListView<String>("tags", tagNames) {
				...
				protected void populateItem(ListItem<String> item) {
					...
					AbstractLink commitLink = new BookmarkablePageLink<Void>("commitlink",
							...
							RepoCommitPage.paramsOf(getRepository(), tag.getSha(), null));
