package com.pmease.gitplex.web.page.repository.source.commit;
...
import com.pmease.gitplex.web.page.repository.source.commit.diff.CommentListPanel;
...
public class SourceCommitPage extends RepositoryInfoPage implements CommitCommentsAware {
	...
	protected void onInitialize() {
		...
		add(new BookmarkablePageLink<Void>("treelink",
				...
				SourceTreePage.paramsOf(getRepository(), getRevision())));
				...
				frag.add(new ListView<String>("refs", (IModel<List<String>>) getDefaultModel()) {
					...
					protected void populateItem(ListItem<String> item) {
						...
						BookmarkablePageLink<Void> link = new BookmarkablePageLink<Void>("link", SourceTreePage.class,
								SourceTreePage.paramsOf(getRepository(), branchName));
