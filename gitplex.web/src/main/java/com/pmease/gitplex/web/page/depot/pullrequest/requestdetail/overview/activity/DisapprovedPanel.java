...
class DisapprovedPanel extends ActivityPanel {

	public DisapprovedPanel(String id, ActivityRenderer activity) {
		super(id, activity);
	}
	...
	protected void onInitialize() {
		...
		add(new SinceChangesLink("changes", requestModel, renderer.getDate()));
	}
