...
@Editable(order=200, name="Branches Matching Specified Patterns")
public class SpecifyTargetBranchesByPatterns implements TargetBranchSelection {

	private String branchPatterns;
	
	@Editable(name="Patterns", description="Specify branch patterns to match. Below is some examples:"
			+ "<ul>"
