...
public abstract class CssTokenizer extends AbstractTokenizer<CssTokenizer.State> {
	...
	public static class Css extends CssTokenizer {
		...
		public Css() {
			TOKEN_HOOKS.put("<", new Processor() {
				...
				public String process(StringStream stream, State state) {
			        if (!stream.match("!--")) 
			        	return "";
			        state.tokenize = new Css.TokenSGMLComment();
	...
	public static class SCSS extends CssTokenizer {
	...
	public static class LESS extends CssTokenizer {
