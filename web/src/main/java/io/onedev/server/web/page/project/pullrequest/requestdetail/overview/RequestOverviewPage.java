package io.onedev.server.web.page.project.pullrequest.requestdetail.overview;
...
import io.onedev.server.web.page.project.pullrequest.requestdetail.overview.activity.CommentedActivity;
import io.onedev.server.web.page.project.pullrequest.requestdetail.overview.activity.OpenedActivity;
import io.onedev.server.web.page.project.pullrequest.requestdetail.overview.activity.ReferencedActivity;
import io.onedev.server.web.page.project.pullrequest.requestdetail.overview.activity.RequestCommentDeleted;
import io.onedev.server.web.page.project.pullrequest.requestdetail.overview.activity.StatusChangeActivity;
import io.onedev.server.web.page.project.pullrequest.requestdetail.overview.activity.UpdatedActivity;
	...
	private WebMarkupContainer newMergeStrategyContainer() {
		...
		editor.add(new OnChangeAjaxBehavior() {
			...
			protected void onUpdate(AjaxRequestTarget target) {
				OneDev.getInstance(PullRequestManager.class).saveMergeStrategy(getPullRequest());
