...
@Singleton
public class OneDevWebApplication extends WebApplication {
	...
	protected void init() {
		...
		mount(new OneDevUrlMapper(this));
	}
	...
	@Inject
	public OneDevWebApplication(Set<ExpectedExceptionContribution> expectedExceptionContributions) {
		this.expectedExceptionContributions = expectedExceptionContributions;
	}
	
	public static OneDevWebApplication get() {
		return (OneDevWebApplication) Application.get();
	}
