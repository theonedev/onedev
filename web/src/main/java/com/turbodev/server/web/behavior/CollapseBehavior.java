...
import com.turbodev.server.web.component.AccordionPanel;
...
public class CollapseBehavior extends Behavior {
	...
	public void renderHead(Component component, IHeaderResponse response) {
		...
		String script = String.format("turbodev.server.setupCollapse('%s', '%s')", component.getMarkupId(), target.getMarkupId());
