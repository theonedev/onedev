...
import com.turbodev.server.web.component.floating.AlignTarget;
import com.turbodev.server.web.component.floating.ComponentTarget;
...
public abstract class InputAssistBehavior extends AbstractPostAjaxBehavior {
	...
	protected void respond(AjaxRequestTarget target) {
		...
		if (type.equals("close")) {
			...
			String script = String.format("turbodev.server.inputassist.markErrors('%s', %s);", 
			...
			if (inputCaret != null) {
				...
				if (!suggestions.isEmpty()) {
					...
					if (dropdown == null) {
						...
						script = String.format("turbodev.server.inputassist.assistOpened('%s', '%s', '%s');", 
						...
						script = String.format("turbodev.server.inputassist.assistUpdated('%s', '%s', '%s');", 
								getComponent().getMarkupId(), dropdown.getMarkupId(), JavaScriptEscape.escapeJavaScript(inputContent));
						target.appendJavaScript(script);
					}
	...
	public void renderHead(Component component, IHeaderResponse response) {
		...
		String script = String.format("turbodev.server.inputassist.init('%s', %s);", 
