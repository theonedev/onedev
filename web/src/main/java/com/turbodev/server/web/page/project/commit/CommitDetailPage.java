...
import com.turbodev.server.web.component.commitmessage.CommitMessageLabel;
import com.turbodev.server.web.component.contributorpanel.ContributorPanel;
import com.turbodev.server.web.component.createbranch.CreateBranchLink;
import com.turbodev.server.web.component.createtag.CreateTagLink;
	...
	protected void onInitialize() {
			...
			public Component getLazyLoadComponent(String markupId) {
				Fragment fragment = new Fragment(markupId, "refsFrag", CommitDetailPage.this) {
					...
					public void renderHead(IHeaderResponse response) {
						...
						String script = String.format("turbodev.server.commitdetail.initRefs('%s');", getMarkupId());
				...
				fragment.add(new ListView<RefInfo>("refs", new LoadableDetachableModel<List<RefInfo>>() {
					...
					protected List<RefInfo> load() {
						Set<ObjectId> descendants = TurboDev.getInstance(CommitInfoManager.class)
		...
		add(new VerificationStatusPanel("verificationStatus", new LoadableDetachableModel<Map<String, Verification>>() {
			...
			protected Map<String, Verification> load() {
				return TurboDev.getInstance(VerificationManager.class).getVerifications(getProject(), getCommit().name());
			}
