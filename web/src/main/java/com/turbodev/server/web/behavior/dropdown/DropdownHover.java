package com.turbodev.server.web.behavior.dropdown;
...
public abstract class DropdownHover extends AbstractPostAjaxBehavior {
		...
		if (dropdown == null) {
			dropdown = new FloatingPanel(target, new ComponentTarget(alignTarget!=null?alignTarget:getComponent()), placement) {
				...
				protected void onClosed() {
					...
					if (target != null) {
						String script = String.format("turbodev.server.dropdownhover.closed('%s', '%s');", 
			...
			String script = String.format("turbodev.server.dropdownhover.opened('%s', '%s');", 
	...
	public void renderHead(Component component, IHeaderResponse response) {
		...
		String script = String.format("turbodev.server.dropdownhover.init('%s', %s, %s);", 
