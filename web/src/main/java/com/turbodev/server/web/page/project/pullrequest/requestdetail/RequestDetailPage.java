...
import static com.turbodev.server.web.page.project.pullrequest.requestdetail.PullRequestOperation.APPROVE;
import static com.turbodev.server.web.page.project.pullrequest.requestdetail.PullRequestOperation.DELETE_SOURCE_BRANCH;
import static com.turbodev.server.web.page.project.pullrequest.requestdetail.PullRequestOperation.DISAPPROVE;
import static com.turbodev.server.web.page.project.pullrequest.requestdetail.PullRequestOperation.DISCARD;
import static com.turbodev.server.web.page.project.pullrequest.requestdetail.PullRequestOperation.REOPEN;
import static com.turbodev.server.web.page.project.pullrequest.requestdetail.PullRequestOperation.RESTORE_SOURCE_BRANCH;
...
import com.turbodev.server.web.component.link.BranchLink;
...
import com.turbodev.server.web.component.tabbable.PageTabLink;
...
import com.turbodev.server.web.websocket.PullRequestChangedRegion;
	...
	protected void onInitialize() {
		...
		form.add(new AjaxButton("save") {
			...
			protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
				...
				if (StringUtils.isNotBlank(getPullRequest().getTitle())) {
					TurboDev.getInstance(Dao.class).persist(getPullRequest());
					editingTitle = false;
				}
		...
		RequestCycle.get().getListeners().add(new IRequestCycleListener() {
			...
			public void onEndRequest(RequestCycle cycle) {
				if (SecurityUtils.getUser() != null) { 
					TurboDev.getInstance(VisitManager.class).visitPullRequest(SecurityUtils.getUser(), getPullRequest());
				}
			}
				...
				if ((operation == APPROVE || operation == DISAPPROVE) && 
					...
					WebMarkupContainer hint = new UnreviewedChangesPanel(HINT_ID, 
						...
						protected PullRequestUpdate load() {
							return TurboDev.getInstance(PullRequestUpdateManager.class).load(prevReviewUpdateId);
						}
