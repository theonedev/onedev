package com.turbodev.server.web.page.project.compare;
...
import com.turbodev.server.web.component.commitlist.CommitListPanel;
import com.turbodev.server.web.component.diff.revision.CommentSupport;
import com.turbodev.server.web.component.diff.revision.RevisionDiffPanel;
import com.turbodev.server.web.component.link.ViewStateAwarePageLink;
import com.turbodev.server.web.component.revisionpicker.AffinalRevisionPicker;
		...
		requestModel = new LoadableDetachableModel<PullRequest>() {
			...
			protected PullRequest load() {
				if (state.leftSide.getBranch() != null && state.rightSide.getBranch() != null) {
					...
					return TurboDev.getInstance(PullRequestManager.class).findEffective(left, right);
				} else {
					return null;
				}
			}
