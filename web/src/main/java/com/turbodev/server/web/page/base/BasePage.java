...
public abstract class BasePage extends WebPage {
	...
	protected void onInitialize() {
		...
		add(new AbstractPostAjaxBehavior() {
			...
			protected void respond(AjaxRequestTarget target) {
				...
				target.appendJavaScript("turbodev.server.viewState.getFromHistoryAndSetToView();");
			}
			...
			public void renderHead(Component component, IHeaderResponse response) {
				...
				String script = String.format("turbodev.server.history.init(%s);", 
	...
	public void pushState(IPartialPageRequestHandler partialPageRequestHandler, String url, Serializable data) {
		...
		String script = String.format("turbodev.server.history.pushState('%s', '%s');", url, encodedData);
	...
	private void checkReady() {
		if (!TurboDev.getInstance().isReady() && getClass() != ServerInitPage.class)
	...
	protected final String getPageTitle() {
		return "TurboDev - Git Management and Code Review";
	};
