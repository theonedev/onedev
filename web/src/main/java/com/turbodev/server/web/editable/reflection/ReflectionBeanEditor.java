...
import com.turbodev.server.util.editable.annotation.Horizontal;
import com.turbodev.server.util.editable.annotation.OmitName;
import com.turbodev.server.util.editable.annotation.Vertical;
...
import com.turbodev.server.web.editable.PathSegment.Property;
...
public class ReflectionBeanEditor extends BeanEditor<Serializable> {
	...
	public void renderHead(IHeaderResponse response) {
		...
		response.render(OnDomReadyHeaderItem.forScript(String.format("turbodev.server.editable.adjustReflectionEditor('%s')", getMarkupId())));
	}
}
