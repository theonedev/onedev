...
public class StringListPropertyEditor extends PropertyEditor<List<String>> {
	...
	public StringListPropertyEditor(String id, PropertyDescriptor propertyDescriptor, IModel<List<String>> propertyModel) {
		...
		com.turbodev.server.util.editable.annotation.ChoiceProvider choiceProvider = 
				propertyDescriptor.getPropertyGetter().getAnnotation(
						com.turbodev.server.util.editable.annotation.ChoiceProvider.class);
	...
	protected void onInitialize() {
        ...
        input = new Select2MultiChoice<String>("input", model, new ChoiceProvider<String>() {
        	...
        	protected void onInitialize() {
        		...
        		getSettings().setFormatResult("turbodev.server.choiceFormatter.formatResult");
        		getSettings().setFormatSelection("turbodev.server.choiceFormatter.formatSelection");
        		getSettings().setEscapeMarkup("turbodev.server.choiceFormatter.escapeMarkup");
