...
import com.turbodev.server.web.page.project.pullrequest.requestdetail.overview.SinceChangesLink;
	...
	private Component newViewer() {
		...
		viewer.add(new MarkdownViewer("content", new IModel<String>() {
			...
			public void setObject(String object) {
				...
				TurboDev.getInstance(PullRequestCommentManager.class).save(getComment());				
			}
		...
		actions.add(new AjaxLink<Void>("delete") {
			...
			@Override
			public void onClick(AjaxRequestTarget target) {
				TurboDev.getInstance(PullRequestCommentManager.class).delete(getComment());
