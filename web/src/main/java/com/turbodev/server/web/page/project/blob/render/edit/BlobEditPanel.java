...
public abstract class BlobEditPanel extends Panel {
		...
		add(new Form<Void>("content") {
			...
			protected void onSubmit() {
				...
				String script = String.format(
						"turbodev.server.blobEdit.selectTab($('#%s>.blob-edit>.head>.save'));", 
	...
	public void onEvent(IEvent<?> event) {
		...
		if (event.getPayload() instanceof BlobNameChanging) {
			...
			String script = String.format("turbodev.server.blobEdit.onNameChanging('%s', %s, %s);", 
	...
	public void renderHead(IHeaderResponse response) {
		...
		String script = String.format("turbodev.server.blobEdit.onDomReady('%s');", getMarkupId()); 
