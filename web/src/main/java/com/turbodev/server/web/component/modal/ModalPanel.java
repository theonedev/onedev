package com.turbodev.server.web.component.modal;
...
public abstract class ModalPanel extends Panel {
	...
	protected void onInitialize() {
		...
		add(new AbstractPostAjaxBehavior() {
			...
			public void renderHead(Component component, IHeaderResponse response) {
				...
				String script = String.format("turbodev.server.modal.onDomReady('%s', %s);", 
	...
	public final void close() {
		...
		if (target != null) {
			String script = String.format("turbodev.server.modal.close($('#%s'), false);", getMarkupId(true));
