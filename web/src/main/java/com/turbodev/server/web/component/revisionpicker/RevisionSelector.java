...
import com.turbodev.server.web.behavior.InputChangeBehavior;
import com.turbodev.server.web.behavior.infinitescroll.InfiniteScrollBehavior;
import com.turbodev.server.web.component.createtag.CreateTagPanel;
...
public abstract class RevisionSelector extends Panel {
	...
	private void onSelectTab(AjaxRequestTarget target) {
		...
		target.add(revField);
		newItemsView(target);
		String script = String.format("turbodev.server.revisionSelector.bindInputKeys('%s');", getMarkupId(true));
	...
	protected void onInitialize() {
		...
		add(new AbstractPostAjaxBehavior() {
			...
			public void renderHead(Component component, IHeaderResponse response) {
				...
				String script = String.format("turbodev.server.revisionSelector.init('%s', %s);", 
