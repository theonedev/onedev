...
public class AuthenticatorPage extends AdministrationPage {
	...
	protected void onInitialize() {
		...
		authenticatorHolder.setAuthenticator(GitPlex.getInstance(ConfigManager.class).getAuthenticator());
		...
		Button saveButton = new Button("save") {
			...
			public void onSubmit() {
				...
				GitPlex.getInstance(ConfigManager.class).saveAuthenticator(authenticatorHolder.getAuthenticator());
