package com.gitplex.server.web.editable.pathpattern;
...
import com.gitplex.server.web.behavior.PathPatternAssistBehavior;
...
public class PathPatternEditor extends PropertyEditor<String> {
	...
	protected void onInitialize() {
        ...
        input.add(new PathPatternAssistBehavior(new AbstractReadOnlyModel<Depot>() {
