...
public final class WicketUtils {
  ...
  public static void appendJavaScript(AjaxRequestTarget target, CharSequence script) {
    if (target != null) {
  ...
  public static Cookie setCookie(String cookieName, String value, String path, int maxAge) {
    return CookieUtils.setCookie(WicketUtils.getHttpServletRequest(),
        WicketUtils.getHttpServletResponse(), cookieName, value, maxAge, path);

  }

  public static void removeCookie(String cookieName) {
    CookieUtils.invalidateCookie(getHttpServletRequest(), getHttpServletResponse(), cookieName);
  }
  ...
  public static PageParameters newPageParams(String k1, String v1, String k2, String v2, String k3,
      String v3) {
