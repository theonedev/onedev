...
public class Gravatar {
  ...
  private static final String[] dfltImages = {"404", "mm", "identicon", "monsterid", "wavatar",
      "retro", "blank"};
  ...
  public Gravatar(String email) {
    ...
    try {
      this.hash = Gravatar.toHexString(MessageDigest.getInstance("MD5").digest(buf));
   ...
   * 
   * @param forceDefault true if the default Gravatar should always be returned
   */
  ...
  public String getCustomDefault() {
    try {
      // UTF-8 should always be supported
      return this.customDefault == null ? null : URLDecoder.decode(this.customDefault, "UTF-8");
    } catch (UnsupportedEncodingException e) {
      e.printStackTrace();
    }
    return null;
  ...
  public static String getURL(String email, boolean secure) {
    return Gravatar.getURL(email, 0, DFLT_DEFAULT, false, RTNG_NONE, secure);
  }
  ...
  /**
   * Get the Gravatar for an email with a specified size, default image, and maximum rating.
   * 
   * @param email the email for this Gravatar
   * @param size the desired size for this Gravatar [1-512]
   * @param dflt must be one of the DFLT_XXX constants
  ...
  /**
   * Get the Gravatar for an email with a specified size, default image, maximum rating, and
   * specified force default option.
   * 
   * @param email the email for this Gravatar
   * @param size the desired size for this Gravatar [1-512]
   * @param dflt must be one of the DFLT_XXX constants
   ...
   * @return the URL of the Gravatar
   */
  public static String getURL(String email, int size, int dflt, boolean forceDefault, int rating) {
    return Gravatar.getURL(email, size, dflt, forceDefault, rating, false);
  }

  /**
   * Get the Gravatar for an email with a specified size, custom default, maximum rating, and
   * specified force default option.
   * 
   * @param email the email for this Gravatar
   * @param size the desired size for this Gravatar [1-512]
   ...
   * @return the URL of the Gravatar
   */
  public static String getURL(String email, int size, String customDefault, boolean forceDefault,
      int rating) {
    return Gravatar.getURL(email, size, customDefault, forceDefault, rating, false);
  }

  /**
   * Get the Gravatar for an email with a specified size, custom default, maximum rating, and
   * specified force default option, and HTTPS preference.
   * 
   * @param email the email for this Gravatar
   * @param size the desired size for this Gravatar [1-512]
   * @param customDefault URL of custom default image
  ...
  /**
   * Get the Gravatar for an email with a specified size, custom default, maximum rating, specified
   * force default option, and HTTPS preference.
   * 
   * @param email the email for this Gravatar
   * @param size the desired size for this Gravatar [1-512]
   * @param customDefault URL of custom default image
