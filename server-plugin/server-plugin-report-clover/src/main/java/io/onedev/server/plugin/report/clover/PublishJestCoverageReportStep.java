...
public class PublishJestCoverageReportStep extends PublishCloverReportStep {
	...
	@Editable(order=100, description="Specify Jest coverage report file in clover format relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job workdir</a>, "
