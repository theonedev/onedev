...
public class PublishJestCoverageReportStep extends PublishCloverReportStep {
	...
	@Editable(order=100, description="Specify Jest coverage report file in clover format under <a href='$docRoot/pages/concepts.md#job-workspace'>job workspace</a>, "
