...
@Editable(name="Slack Notifications", order=100, description="Set up slack notification settings. Settings will be "
		+ "inherited by child projects, and can be overriden by defining setting with same webhook url")
