	...
	public Component render(String componentId) {
		return new PageTabHead(componentId, this) {
			...
			protected Link<?> newLink(String linkId, Class<? extends Page> pageClass) {
				...
				String startPage = LockUtils.read(page.getBuild().getReportCategoryLockKey(MarkdownReportModule.CATEGORY), new Callable<String>() {

					@Override
					public String call() throws Exception {
						File startPageFile = new File(page.getBuild().getReportCategoryDir(MarkdownReportModule.CATEGORY), 
								getTitle() + "/" + MarkdownReportModule.START_PAGE);
