package org.server.plugin.buildspec.gradle;
	...
	protected void configure() {
		...
		contribute(ScriptContribution.class, new ScriptContribution() {
			...
			public GroovyScript getScript() {
				...
				script.setContent(Lists.newArrayList("org.server.plugin.buildspec.gradle.GradleJobSuggestion.determineDockerImage()"));
				return script;
			}
