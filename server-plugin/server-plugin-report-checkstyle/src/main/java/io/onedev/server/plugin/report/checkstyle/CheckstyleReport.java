...
public class CheckstyleReport implements Serializable {

	private static final long serialVersionUID = 1L;
	
	public static final String CATEGORY = "checkstyle";
	...
	public CheckstyleReport(List<CheckstyleViolation> violations) {
