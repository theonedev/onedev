...
public class DateUtilsTest {
	...
	public void test() {
		...
		assertEquals("0h", DateUtils.formatWorkingPeriod(DateUtils.parseWorkingPeriod("0h")));
		assertEquals("0h", DateUtils.formatWorkingPeriod(DateUtils.parseWorkingPeriod("0")));
		try {
