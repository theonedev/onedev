...
public class ExtractTranslationKeysTest {
    ...
    public void testExtractWithMethod() {
        ...
        assertArrayEquals(new String[] {"helloworld", "onetwothree"}, ExtractTranslationKeys.extract_T(content).toArray());
    }
    ...
    public void testUpdateTranslationKeys() {            
        var content = "\n" 
            ...
            + "\n" 
            + "\t\t\t//  Manually added  keys";
        assertEquals("\n\t\t//  Extracted  keys\n\t\tm.put(\"message1\", \"消息$100\");\n\t\tm.put(\"message2\", \"**** translate this ****\");\n\t\tm.put(\"message3\", \"**** translate this ****\");\n\n\t\t\t//  Manually added  keys", ExtractTranslationKeys.updateTranslationKeys(content, List.of("message1", "message2", "message3")));
    }
}
