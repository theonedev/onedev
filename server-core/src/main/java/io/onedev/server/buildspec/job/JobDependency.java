...
public class JobDependency implements Serializable {
	...
	@Editable(order=300, name="Artifacts to Retrieve", description="Optionally specify artifacts to retrieve "
			+ "from the dependency into <a href='https://code.onedev.io/projects/onedev-manual/blob/master/pages/concepts.md#job-workspace' target='_blank'>job workspace</a>. Leave empty to do not retrieve any artifacts. "
