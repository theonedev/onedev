...
public class Job implements Serializable, Validatable {
	...
	private String defaultFixedIssuesFilter;
	...
	@Editable(order=10700, group="More Settings", description="Optionally specify a default query "
			+ "to filter/order fixed issues of the builds generated by current job")
	@IssueQuery(withCurrentBuildCriteria = false, withCurrentCommitCriteria = false, 
			...
			withOrder = true)
	@NameOfEmptyValue("No default filter")
	public String getDefaultFixedIssuesFilter() {
		return defaultFixedIssuesFilter;
	}

	public void setDefaultFixedIssuesFilter(String defaultFixedIssuesFilterQuery) {
