...
public class PullRequestQueryPersonalizationResource {
	...
	@Api(order=200, description="Update pull request query personalization of specified id in request body, or create new if id property not provided")
	@POST
	public Long createOrUpdate(@NotNull PullRequestQueryPersonalization queryPersonalization) {
