...
@Editable(order=510, name="Branch is created")
public class BranchCreatedSpec extends AutoSpec {

	private static final long serialVersionUID = 1L;

	private String branches;

	public BranchCreatedSpec() {
		setIssueQuery(io.onedev.server.search.entity.issue.IssueQuery
				.getRuleName(IssueQueryLexer.ReferencedInCurrentBranch));
	}
	...
	@IssueQuery(withOrder = false, withCurrentBranchCriteria = true)
	@Override
	...
	public String getTriggerDescription() {
		if (branches != null)
			return MessageFormat.format(_T("branch \"{0}\" is created"), branches);
		else
			return _T("branch is created");
	}
