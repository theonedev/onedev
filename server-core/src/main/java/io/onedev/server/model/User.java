...
public class User extends AbstractEntity implements AuthenticationInfo {
	...
	public boolean isDisableWatchNotifications() {
		return disableWatchNotifications;
	}

	public void setDisableWatchNotifications(boolean disableWatchNotifications) {
		this.disableWatchNotifications = disableWatchNotifications;
	}
