...
public class CodeCommentQueryEditor extends PropertyEditor<String> {
	
	private TextField<String> input;
	
	public CodeCommentQueryEditor(String id, PropertyDescriptor propertyDescriptor, IModel<String> propertyModel) {
