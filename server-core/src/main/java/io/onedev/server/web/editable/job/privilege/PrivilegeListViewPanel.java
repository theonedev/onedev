...
class PrivilegeListViewPanel extends Panel {

	private final List<JobPrivilege> privileges = new ArrayList<>();
	
	public PrivilegeListViewPanel(String id, List<Serializable> elements) {
		super(id);
	...
	private abstract class ColumnFragment extends Fragment {
		...
		public ColumnFragment(String id, int index) {
			super(id, "columnFrag", PrivilegeListViewPanel.this);
			this.index = index;
		}
