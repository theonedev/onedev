...
public class BaseUrlMapper extends CompoundRequestMapper {
	...
	public BaseUrlMapper(WebApplication app) {
		...
		add(new BasePageMapper("~ai-sessions", AiSessionListPage.class));
	...
	private void addMyPages() {
		...
		add(new BasePageMapper("~my/ai-system-prompt", MySystemPromptPage.class));
	...
	private void addUserPages() {
		...
		add(new BasePageMapper("~users/${user}/ai-system-prompt", UserSystemPromptPage.class));
	...
	private void addAdministrationPages() {
		...
		add(new BasePageMapper("~administration/settings/ai-dispatch", DispatchSettingsPage.class));
	...
	private void addProjectPages() {
		...
		add(new ProjectPageMapper("${project}/~pulls/${request}/ai-runs", PullRequestAiRunsPage.class));
