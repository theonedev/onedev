...
public abstract class IssueQueryProgressPanel extends Panel {
	...
	public IssueQueryProgressPanel(String id) {
		super(id);
	}
	...
	public void renderHead(IHeaderResponse response) {
		...
		response.render(CssHeaderItem.forReference(new IssueQueryProgressCssResourceReference()));
	}
