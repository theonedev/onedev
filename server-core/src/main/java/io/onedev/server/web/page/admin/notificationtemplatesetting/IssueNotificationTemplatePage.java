...
public class IssueNotificationTemplatePage extends AdministrationPage {
	...
	protected void onInitialize() {
		...
		variableHelp.put("issue", " represents the <a href='https://code.onedev.io/projects/onedev-server/blob/main/server-core/src/main/java/io/onedev/server/model/Issue.java' target='_blank'>issue</a> object to be notified");
