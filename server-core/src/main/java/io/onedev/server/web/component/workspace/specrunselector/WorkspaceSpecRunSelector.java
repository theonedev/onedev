...
public abstract class WorkspaceSpecRunSelector extends Panel {
	...
	public WorkspaceSpecRunSelector(String id, String branch) {
		super(id);
		this.branch = branch;
	}
	...
	private Component newItem(String componentId, WorkspaceSpec spec) {
		...
		var link = new AjaxLink<Void>("link") {
			...
			public void onClick(AjaxRequestTarget target) {
				var workspace = workspaceService.create(SecurityUtils.getUser(), getProject(), branch, spec.getName());
	...
	public void renderHead(IHeaderResponse response) {
		...
		response.render(CssHeaderItem.forReference(new WorkspaceSpecRunSelectorCssResourceReference()));
