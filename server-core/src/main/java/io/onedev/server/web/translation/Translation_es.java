...
public class Translation_es extends TranslationResourceBundle {
	...
	public static void init(Map<String, String> m) {
		...
		m.put("<b>NOTE: </b> Service desk only takes effect if <a wicket:id=\"mailService\">mail service</a> is defined and its <tt>check incoming email</tt> option is enabled. Also <a href='https://en.wikipedia.org/wiki/Email_address#Subaddressing' target='_blank'>sub addressing</a> needs to be enabled for the system email address. Check <a href=\"https://medium.com/p/e56d62c27e57\" target='_blank'>this tutorial</a> for details", 
			"<b>NOTA: </b> El servicio de mesa de ayuda solo tiene efecto si <a wicket:id=\"mailService\">el servicio de correo</a> está definido y su opción <tt>verificar correo entrante</tt> está habilitada. También se necesita habilitar <a href='https://en.wikipedia.org/wiki/Email_address#Subaddressing' target='_blank'>subdireccionamiento</a> para la dirección de correo del sistema. Consulte <a href=\"https://medium.com/p/e56d62c27e57\" target='_blank'>este tutorial</a> para más detalles");
		...
		m.put("Add member...", "Añadir miembro...");
		...
		m.put("Delete All Queried Memberships", "Eliminar todas las membresías consultadas");
		...
		m.put("Delete Selected Memberships", "Eliminar membresías seleccionadas");
		...
		m.put("Disabled users are excluded from user-month check", "Los usuarios deshabilitados están excluidos de la verificación de usuario por mes");
		...
		m.put("Group added", "Grupo añadido");
		...
		m.put("License Group:", "Grupo de Licencia:");
		...
		m.put("Member added", "Miembro añadido");
		...
		m.put("More", "Más");
		m.put("More Activities", "Más actividades");
		...
		m.put("No executors defined. Jobs will use auto-discovered executor with default settings", 
			"No hay ejecutores definidos. Los trabajos usarán el ejecutor descubierto automáticamente con configuraciones predeterminadas");
		...
		m.put("No memberships to delete", "No hay membresías para eliminar");
		...
		m.put("Please select memberships to delete", "Por favor seleccione membresías para eliminar");
		...
		m.put("Storage Setting", "Configuración de Almacenamiento");
		...
		m.put("Type <code>yes</code> below to delete all queried memberships", "Escriba <code>yes</code> abajo para eliminar todas las membresías consultadas");
		...
		m.put("Type <code>yes</code> below to delete selected memberships", "Escriba <code>yes</code> abajo para eliminar las membresías seleccionadas");
		...
		m.put("With current number of users ({0}) in group \"{1}\", the subscription will be active until <b>{2}</b>", 
			"Con el número actual de usuarios ({0}) en el grupo \"{1}\", la suscripción estará activa hasta <b>{2}</b>");
