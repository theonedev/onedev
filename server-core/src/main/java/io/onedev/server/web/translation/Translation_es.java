...
public class Translation_es extends TranslationResourceBundle {
	...
	public static void init(Map<String, String> m) {
		...
		m.put("<b class='text-danger'>NOTE: </b>Kubernetes provisioner is an enterprise feature. <a href='https://onedev.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b>El provisionador de Kubernetes es una característica empresarial. <a href='https://onedev.io/pricing' target='_blank'>Prueba gratis</a> por 30 días");
		m.put("<b class='text-danger'>NOTE: </b>Remote docker provisioner is an enterprise feature. <a href='https://onedev.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b>El provisionador de Docker remoto es una característica empresarial. <a href='https://onedev.io/pricing' target='_blank'>Prueba gratis</a> por 30 días");
		m.put("<b class='text-danger'>NOTE: </b>Remote shell provisioner is an enterprise feature. <a href='https://onedev.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b>El provisionador de shell remoto es una característica empresarial. <a href='https://onedev.io/pricing' target='_blank'>Prueba gratis</a> por 30 días");
		...
		m.put("<b>NOTE: </b> Transition rules can also be configured and overridden at project level", 
			"<b>NOTA: </b> Las reglas de transición también se pueden configurar y sobrescribir a nivel de proyecto");
		m.put("<b>NOTE: </b> Transition rules can also be configured and overridden at project level in enterprise edition", 
			"<b>NOTA: </b> Las reglas de transición también se pueden configurar y sobrescribir a nivel de proyecto en la edición empresarial");
		...
		m.put("<b>Tips: </b> Type <tt>@</tt> to <a href='https://docs.onedev.io/appendix/workspace-variables' target='_blank' tabindex='-1'>insert variable</a>. Use <tt>@@</tt> for literal <tt>@</tt>", 
			"<b>Consejos: </b> Escribe <tt>@</tt> para <a href='https://docs.onedev.io/appendix/workspace-variables' target='_blank' tabindex='-1'>insertar variable</a>. Usa <tt>@@</tt> para literal <tt>@</tt>");
		...
		m.put("AI behavior settings have been saved", "La configuración del comportamiento de la IA ha sido guardada");
		...
		m.put("AI settings updated", "Configuraciones de IA actualizadas");
		m.put("API Key", "Clave API");
		m.put("API Token", "Token de API");
		m.put("API token should be generated with permission to read your account and repositories", 
			"El token de API debe generarse con permiso para leer tu cuenta y repositorios");
		...
		m.put("Abort Merge", "Abortar Fusión");
		m.put("Absolute", "Absoluto");
		...
		m.put("Add Provisioner", "Agregar Proveedor");
		...
		m.put("Add environment variable", "Agregar variable de entorno");
		...
		m.put("Add new cache config", "Agregar nueva configuración de caché");
		m.put("Add new card to this column", "Añadir nueva tarjeta a esta columna");
		m.put("Add new config file", "Agregar nuevo archivo de configuración");
		...
		m.put("Add web hook", "Agregar web hook");
		m.put("Add {0}", "Añadir {0}");
		m.put("Added by them", "Agregado por ellos");
		m.put("Added by us", "Agregado por nosotros");
		...
		m.put("Additional Job Privileges", "Privilegios Adicionales de Trabajo");
		m.put("Additional Privileges", "Privilegios Adicionales");
		...
		m.put("All members of entitled groups will be able to chat with the AI user and mention it in issues or pull requests to ask questions or give instructions", 
			"Todos los miembros de los grupos autorizados podrán chatear con el usuario de IA y mencionarlo en problemas o solicitudes de extracción para hacer preguntas o dar instrucciones");
		...
		m.put("Also accepts cross-project linking in form of <code>projectpath#100</code> or <code>PROJECTKEY-100</code>", 
			"También acepta enlaces entre proyectos en forma de <code>projectpath#100</code> o <code>PROJECTKEY-100</code>");
		m.put("Also add below to $HOME/.m2/settings.xml if you want to compile project from command line", 
			"También agregue lo siguiente a $HOME/.m2/settings.xml si desea compilar el proyecto desde la línea de comandos");
		m.put("Always", "Siempre");
		m.put("Always Pull Image", "Siempre extraer imagen");
		m.put("Amend", "Modificar");
		...
		m.put("And login to the registry", "Y accede al registro");
		m.put("Another pull request already open for this change", "Ya hay una solicitud de extracción abierta para este cambio");
		m.put("Another workspace spec with the same name already exists", "Ya existe otra especificación de espacio de trabajo con el mismo nombre");
		...
		m.put("Append", "Anexar");
		m.put("Applicable AI Users for Task Automation", "Usuarios de IA aplicables para la automatización de tareas");
		...
		m.put("Associated Branch", "Rama asociada");
		...
		m.put("Behavior", "Comportamiento");
		m.put("Behavior Edit Bean", "Editar Comportamiento Bean");
		...
		m.put("Bold", "Negrita");
		m.put("Both", "Ambos");
		m.put("Both added", "Ambos agregados");
		m.put("Both deleted", "Ambos eliminados");
		m.put("Both modified", "Ambos modificados");
		m.put("Both sides deleted this file", "Ambos lados eliminaron este archivo");
		...
		m.put("Builtin Chat Prompts", "Indicaciones de Chat Integradas");
		...
		m.put("By default, AI user only responds when assigned tasks or mentioned in issue/PR context.\nEnable this to have it respond as long as the comment is relevant even if not mentioned.\nThis provides a better interaction experience, especially in case of service desks,\nbut may consume more tokens", 
			"Por defecto, el usuario de IA solo responde cuando se le asignan tareas o se le menciona en el contexto de un problema/PR.\nHabilita esto para que responda siempre que el comentario sea relevante, incluso si no se le menciona.\nEsto proporciona una mejor experiencia de interacción, especialmente en el caso de mesas de servicio,\npero puede consumir más tokens");
		m.put("By default, users are only allowed to edit fields specified above for issues submitted by themselves.\nEnable this option to allow to edit fields for issues submitted by others.", 
			"De forma predeterminada, los usuarios solo pueden editar los campos especificados anteriormente para los problemas que hayan enviado ellos mismos.\nHabilita esta opción para permitir la edición de campos en problemas enviados por otros.");
		m.put("By default, users can access artifacts from all jobs. To assign additional privileges to specific jobs, specify them here.", 
			"De forma predeterminada, los usuarios pueden acceder a artefactos de todos los trabajos. Para asignar privilegios adicionales a trabajos específicos, especifíquelos aquí.");
		...
		m.put("CPU request for the workspace container.", "Solicitud de CPU para el contenedor del espacio de trabajo.");
		m.put("Cache \"{0}\" deleted", "Caché \"{0}\" eliminado");
		m.put("Cache Config", "Configuración de Caché");
		m.put("Cache Entries", "Entradas de caché");
		m.put("Cache Entry", "Entrada de caché");
		...
		m.put("Can Be Used By Workspace Specs", "Puede ser usado por Especificaciones de Espacio de Trabajo");
		m.put("Can Be Used By Workspaces", "Puede ser usado por Espacios de Trabajo");
		m.put("Can Create Root Projects", "Puede Crear Proyectos Raíz");
		m.put("Can Edit Estimated Time", "Puede Editar Tiempo Estimado");
		m.put("Can Edit Fields Of Other Issues", "Pueden editar campos de otros problemas");
		...
		m.put("Cannot convert root user to service account", "No se puede convertir el usuario root a cuenta de servicio");
		m.put("Cannot convert yourself to service account", "No se puede convertir a sí mismo a cuenta de servicio");
		m.put("Cannot delete branch as it has workspaces", "No se puede eliminar la rama ya que tiene espacios de trabajo");
		m.put("Cannot delete default branch", "No se puede eliminar la rama predeterminada");
		m.put("Cannot delete issue as it has workspaces", "No se puede eliminar el problema ya que tiene espacios de trabajo");
		m.put("Cannot delete pull request as it has workspaces", "No se puede eliminar la solicitud de extracción ya que tiene espacios de trabajo");
		m.put("Cannot delete root account", "No se puede eliminar la cuenta raíz");
		m.put("Cannot delete source branch as it has workspaces", "No se puede eliminar la rama de origen ya que tiene espacios de trabajo");
		...
		m.put("Changes", "Cambios");
		m.put("Changes committed successfully", "Cambios comprometidos exitosamente");
		...
		m.put("Chat Preserve Days", "Días de preservación del chat");
		m.put("Chat Prompts", "Indicaciones de Chat");
		m.put("Chat deleted", "Chat eliminado");
		m.put("Chat preserve days setting has been saved", "La configuración de días de preservación del chat ha sido guardada");
		m.put("Chat prompt has been reverted to default", "El mensaje del chat ha sido restablecido a los valores predeterminados");
		m.put("Chat prompt has been saved", "El mensaje del chat ha sido guardado");
		...
		m.put("Chats older than the specified number of days will be automatically deleted during daily maintenance.", 
			"Los chats más antiguos que el número especificado de días se eliminarán automáticamente durante el mantenimiento diario.");
		...
		m.put("Check out to local directory", "Revisar en directorio local");
		...
		m.put("Checksum", "Suma de verificación");
		m.put("Checksum Files", "Archivos de Suma de Verificación");
		...
		m.put("Click to copy", "Haz clic para copiar");
		...
		m.put("Close terminal", "Cerrar terminal");
		...
		m.put("Command to Run Task", "Comando para ejecutar la tarea");
		...
		m.put("Commit Message Fix Setting", "Configuración de Corrección de Mensajes de Commit");
		m.put("Commit Message Fix Settings", "Configuraciones de Corrección de Mensajes de Commit");
		...
		m.put("Commit message", "Mensaje de confirmación");
		...
		m.put("Commit suggestion", "Sugerencia de Commit");
		m.put("Commit to conclude the merge, or", "Confirma para concluir la fusión, o");
		...
		m.put("Config Files", "Archivos de Configuración");
		...
		m.put("Configure how coding agents should reference fixed issues in commit messages, and specify prefix/suffix patterns to detect fixed issues in commit messages.", 
			"Configura cómo los agentes de codificación deben referenciar problemas corregidos en los mensajes de commit, y especifica patrones de prefijo/sufijo para detectar problemas corregidos en los mensajes de commit.");
		m.put("Configure shell of the workspace. It will be used to launch workspace terminal, run workspace setup commands etc\n", 
			"Configure el shell del espacio de trabajo. Se usará para lanzar el terminal del espacio de trabajo, ejecutar comandos de configuración del espacio de trabajo, etc.\n");
		...
		m.put("Conflict", "Conflicto");
		m.put("Conflicts found when trying to merge", "Conflictos encontrados al intentar fusionar");
		...
		m.put("Copied", "Copiado");
		m.put("Copied to clipboard", "Copiado al portapapeles");
		m.put("Copy", "Copiar");
		...
		m.put("Copy permanent link", "Copiar enlace permanente");
		...
		m.put("Create Workspaces", "Crear espacios de trabajo");
		m.put("Create a workspace spec running Claude Code directly with server shell environment.\nWorkspaces using created spec will share same environments and settings.\nTo use this template, please ensure that:\n<ul>\n    <li><a href='https://code.claude.com/docs/en/overview' target='_blank'>Claude Code</a> is installed on OneDev server</li>\n    <li><a href='https://code.onedev.io/onedev/tod/~files/main/readme.md' target='_blank'>TOD</a> is installed on OneDev server and companion skills are installed for Claude Code</li>\n    <li>A shell provisioner is added in 'Administration / Workspace Provisioners' with 'applicable projects' configured properly</li>\n</ul>", 
			"Crea una especificación de espacio de trabajo ejecutando Claude Code directamente con el entorno de shell del servidor.\nLos espacios de trabajo que utilicen la especificación creada compartirán los mismos entornos y configuraciones.\nPara usar esta plantilla, asegúrate de que:\n<ul>\n    <li><a href='https://code.claude.com/docs/en/overview' target='_blank'>Claude Code</a> está instalado en el servidor OneDev</li>\n    <li><a href='https://code.onedev.io/onedev/tod/~files/main/readme.md' target='_blank'>TOD</a> está instalado en el servidor OneDev y las habilidades complementarias están instaladas para Claude Code</li>\n    <li>Se ha añadido un aprovisionador de shell en 'Administración / Aprovisionadores de Espacios de Trabajo' con los 'proyectos aplicables' configurados correctamente</li>\n</ul>");
		...
		m.put("Create a workspace spec running Codex directly with server shell environment.\nWorkspaces using created spec will share same environments and settings.\nTo use this template, please ensure that:\n<ul>\n    <li><a href='https://openai.com/codex/' target='_blank'>Codex</a> is installed on OneDev server</li>\n    <li><a href='https://code.onedev.io/onedev/tod/~files/main/readme.md' target='_blank'>TOD</a> is installed on OneDev server and companion skills are installed for Codex</li>\n    <li>A shell provisioner is added in 'Administration / Workspace Provisioners' with 'applicable projects' configured properly</li>\n</ul>", 
			"Crea una especificación de espacio de trabajo ejecutando Codex directamente con el entorno de shell del servidor.\nLos espacios de trabajo que utilicen la especificación creada compartirán los mismos entornos y configuraciones.\nPara usar esta plantilla, asegúrate de que:\n<ul>\n    <li><a href='https://openai.com/codex/' target='_blank'>Codex</a> está instalado en el servidor OneDev</li>\n    <li><a href='https://code.onedev.io/onedev/tod/~files/main/readme.md' target='_blank'>TOD</a> está instalado en el servidor OneDev y las habilidades complementarias están instaladas para Codex</li>\n    <li>Se ha añadido un aprovisionador de shell en 'Administración / Aprovisionadores de Espacios de Trabajo' con los 'proyectos aplicables' configurados correctamente</li>\n</ul>");
		...
		m.put("Create a workspace spec running Cursor directly with server shell environment.\nWorkspaces using created spec will share same environments and settings.\nTo use this template, please ensure that:\n<ul>\n    <li><a href='https://cursor.com/docs/cli/overview' target='_blank'>Cursor CLI</a> is installed on OneDev server</li>\n    <li><a href='https://code.onedev.io/onedev/tod/~files/main/readme.md' target='_blank'>TOD</a> is installed on OneDev server and companion skills are installed for Cursor CLI</li>\n    <li>A shell provisioner is added in 'Administration / Workspace Provisioners' with 'applicable projects' configured properly</li>\n</ul>", 
			"Crea una especificación de espacio de trabajo ejecutando Cursor directamente con el entorno de shell del servidor.\nLos espacios de trabajo que utilicen la especificación creada compartirán los mismos entornos y configuraciones.\nPara usar esta plantilla, asegúrate de que:\n<ul>\n    <li><a href='https://cursor.com/docs/cli/overview' target='_blank'>Cursor CLI</a> esté instalado en el servidor OneDev</li>\n    <li><a href='https://code.onedev.io/onedev/tod/~files/main/readme.md' target='_blank'>TOD</a> esté instalado en el servidor OneDev y las habilidades complementarias estén instaladas para Cursor CLI</li>\n    <li>Se haya agregado un aprovisionador de shell en 'Administración / Aprovisionadores de Espacios de Trabajo' con los 'proyectos aplicables' configurados correctamente</li>\n</ul>");
		m.put("Create a workspace spec running Cursor inside container for isolation and security purpose.\nYou may customize the <a href='https://code.onedev.io/onedev/docker/cursor' target='_blank'>container image</a>\nlater to suit your needs if desired", 
			"Crea una especificación de espacio de trabajo ejecutando Cursor dentro de un contenedor para propósitos de aislamiento y seguridad.\nPuedes personalizar la <a href='https://code.onedev.io/onedev/docker/cursor' target='_blank'>imagen del contenedor</a>\nmás tarde para adaptarla a tus necesidades si lo deseas");
		m.put("Create a workspace spec running Open Code directly with server shell environment.\nWorkspaces using created spec will share same environments and settings.\nTo use this template, please ensure that:\n<ul>\n    <li><a href='https://opencode.ai/' target='_blank'>Open Code</a> is installed on OneDev server</li>\n    <li><a href='https://code.onedev.io/onedev/tod/~files/main/readme.md' target='_blank'>TOD</a> is installed on OneDev server and companion skills are installed for Open Code</li>\n    <li>A shell provisioner is added in 'Administration / Workspace Provisioners' with 'applicable projects' configured properly</li>\n</ul>", 
			"Crea una especificación de espacio de trabajo ejecutando Open Code directamente con el entorno de shell del servidor.\nLos espacios de trabajo que utilicen la especificación creada compartirán los mismos entornos y configuraciones.\nPara usar esta plantilla, asegúrate de que:\n<ul>\n    <li><a href='https://opencode.ai/' target='_blank'>Open Code</a> está instalado en el servidor OneDev</li>\n    <li><a href='https://code.onedev.io/onedev/tod/~files/main/readme.md' target='_blank'>TOD</a> está instalado en el servidor OneDev y las habilidades complementarias están instaladas para Open Code</li>\n    <li>Se ha añadido un aprovisionador de shell en 'Administración / Aprovisionadores de Espacios de Trabajo' con los 'proyectos aplicables' configurados correctamente</li>\n</ul>");
		...
		m.put("Create an issue for this failure", "Crear un problema para este fallo");
		...
		m.put("Create from Template", "Crear desde Plantilla");
		m.put("Create issue", "Crear problema");
		m.put("Create merge commit", "Crear commit de fusión");
		m.put("Create merge commit if necessary", "Crear commit de fusión si es necesario");
		...
		m.put("Create workspace with this spec", "Crear espacio de trabajo con esta especificación");
		m.put("Create workspaces on any commit or branch under a project.\nThis permission implies the permission to read code.\n", 
			"Crear espacios de trabajo en cualquier commit o rama dentro de un proyecto.\nEste permiso implica el permiso para leer código.\n");
		m.put("Created", "Creado");
		m.put("Created After", "Creado Después");
		m.put("Created At", "Creado en");
		m.put("Created Before", "Creado Antes");
		m.put("Created By", "Creado Por");
		...
		m.put("Data Entries", "Entradas de datos");
		m.put("Data Key", "Clave de Datos");
		...
		m.put("Default Fork Root", "Raíz de Fork Predeterminada");
		...
		m.put("Define content of the <a href='https://groovy-lang.org' target='_blank'>groovy script</a>", 
			"Define el contenido del <a href='https://groovy-lang.org' target='_blank'>script groovy</a>");
		...
		m.put("Define how issues may move from one state to another in this project. At evaluation time, rules from this project, each ancestor project up to the root, and the global rules are merged in that order; the first matching rule applies.", 
			"Defina cómo los problemas pueden moverse de un estado a otro en este proyecto. En el momento de la evaluación, las reglas de este proyecto, cada proyecto ancestro hasta la raíz, y las reglas globales se combinan en ese orden; se aplica la primera regla coincidente.");
		m.put("Define how issues move between states: manually by users, or automatically in response to events. The first matching rule applies.", 
			"Defina cómo los problemas se mueven entre estados: manualmente por los usuarios, o automáticamente en respuesta a eventos. Se aplica la primera regla coincidente.");
		...
		m.put("Define workspace specs for the project. Child projects inherit specs from parent projects. Specs defined in child project override those with the same name from parent project", 
			"Define especificaciones de espacio de trabajo para el proyecto. Los proyectos hijos heredan especificaciones de proyectos padres. Las especificaciones definidas en el proyecto hijo anulan aquellas con el mismo nombre del proyecto padre");
		...
		m.put("Delete All Queried Workspaces", "Eliminar Todos los Espacios de Trabajo Consultados");
		...
		m.put("Delete Selected Workspaces", "Eliminar Espacios de Trabajo Seleccionados");
		...
		m.put("Delete Workspace If Succeeded", "Eliminar espacio de trabajo si tiene éxito");
		...
		m.put("Delete this provisioner", "Eliminar este proveedor");
		m.put("Delete this rule", "Eliminar esta regla");
		m.put("Delete this secret", "Eliminar este secreto");
		m.put("Delete this spec", "Eliminar esta especificación");
		...
		m.put("Disabled users, service accounts, and AI users are excluded from user-month calculation", 
			"Los usuarios deshabilitados, cuentas de servicio y usuarios de IA están excluidos del cálculo de usuarios por mes");
		...
		m.put("Discard All", "Descartar Todo");
		...
		m.put("Do not retrieve groups", "No recuperar grupos");
		m.put("Do you really want to abort the merge?", "¿Realmente quieres abortar la fusión?");
		...
		m.put("Do you really want to delete this provisioner?", "¿Realmente quieres eliminar este proveedor?");
		...
		m.put("Do you really want to delete this web hook?", "¿Realmente quieres eliminar este web hook?");
		m.put("Do you really want to delete this workspace data?", "¿Realmente quieres eliminar estos datos de espacio de trabajo?");
		m.put("Do you really want to delete this workspace spec?", "¿Realmente quieres eliminar esta especificación de espacio de trabajo?");
		m.put("Do you really want to delete this workspace?", "¿Realmente quieres eliminar este espacio de trabajo?");
		...
		m.put("Do you really want to discard all unstaged changes? This cannot be undone.", "¿Realmente quieres descartar todos los cambios no preparados? Esto no se puede deshacer.");
		...
		m.put("Do you really want to revert to default prompt?", "¿Realmente deseas restablecer el mensaje predeterminado?");
		...
		m.put("Edit", "Editar");
		m.put("Edit <code>$HOME/.cargo/config.toml</code> to add a registry like below", "Edita <code>$HOME/.cargo/config.toml</code> para agregar un registro como el siguiente");
		...
		m.put("Edit Provisioner", "Editar Proveedor");
		...
		m.put("Edit this provisioner", "Editar este proveedor");
		m.put("Edit this rule", "Editar esta regla");
		m.put("Edit this secret", "Editar este secreto");
		m.put("Edit this spec", "Editar esta especificación");
		...
		m.put("Editor", "Editor");
		m.put("Either specify value or secret value of the environment variable", "Especifica el valor o el valor secreto de la variable de entorno");
		...
		m.put("Enable this to retrieve Git LFS files", "Habilita esto para recuperar archivos Git LFS");
		...
		m.put("Entitle to All Users and Projects", "Conceder a Todos los Usuarios y Proyectos");
		...
		m.put("Entitled projects and all their sub-projects will be able to assign the AI user to work on issues or pull requests", 
			"Los proyectos autorizados y todos sus subproyectos podrán asignar al usuario de IA para trabajar en problemas o solicitudes de extracción");
		m.put("Entitled projects can assign the AI user to work on issues and pull requests. In this mode, the AI user executes tasks using its own permissions.", 
			"Los proyectos autorizados pueden asignar al usuario de IA para trabajar en problemas y solicitudes de extracción. En este modo, el usuario de IA ejecuta tareas utilizando sus propios permisos.");
		m.put("Entitled users can interact with the AI user through the chat interface to perform tasks such as understanding codebase, summarizing issue/PR comments, or authoring CI/CD spec. In this mode, the AI user operates with same permissions as the user interacting with it, ignoring permissions assigned to the AI user itself.", 
			"Los usuarios autorizados pueden interactuar con el usuario de IA a través de la interfaz de chat para realizar tareas como entender la base de código, resumir comentarios de problemas/PR o redactar especificaciones de CI/CD. En este modo, el usuario de IA opera con los mismos permisos que el usuario que interactúa con él, ignorando los permisos asignados al propio usuario de IA.");
		m.put("Entitled users can mention the AI user in issue or pull request comments to ask questions or give instructions. In this mode, the AI user executes tasks using its own permissions.", 
			"Los usuarios autorizados pueden mencionar al usuario de IA en comentarios de problemas o solicitudes de extracción para hacer preguntas o dar instrucciones. En este modo, el usuario de IA ejecuta tareas utilizando sus propios permisos.");
		m.put("Entitled users will be able to chat with the AI user and mention it in issues or pull requests to ask questions or give instructions.", 
			"Los usuarios autorizados podrán chatear con el usuario de IA y mencionarlo en problemas o solicitudes de extracción para hacer preguntas o dar instrucciones.");
		...
		m.put("Excluded Files for Review", "Archivos Excluidos para Revisión");
		...
		m.put("Exposed Ports", "Puertos Expuestos");
		...
		m.put("File changes", "Cambios en el Archivo");
		m.put("File is binary", "El archivo es binario");
		m.put("File is too large to be displayed", "El archivo es demasiado grande para ser mostrado");
		...
		m.put("Five years", "Cinco años");
		m.put("Fix", "Corregir");
		m.put("Fix Detection", "Detección de Corrección");
		m.put("Fix Pattern", "Patrón de Corrección");
		m.put("Fix Suggestion", "Sugerencia de Corrección");
		...
		m.put("Fix failed builds", "Arreglar compilaciones fallidas");
		...
		m.put("For CI/CD job, add this package to Cargo.toml and run below to install the package via command step", 
			"Para el trabajo de CI/CD, agrega este paquete a Cargo.toml y ejecuta lo siguiente para instalar el paquete mediante el paso de comando");
		...
		m.put("For CI/CD job, it is more convenient to use a custom settings.xml, for instance via below code in a command step:", 
			"Para el trabajo de CI/CD, es más conveniente usar un settings.xml personalizado, por ejemplo, a través del siguiente código en un paso de comando:");
		m.put("For CI/CD job, run below to add package registry via command step", "Para el trabajo de CI/CD, ejecuta lo siguiente para agregar el registro del paquete mediante el paso de comando");
		...
		m.put("Git command failed with exit code", "El comando Git falló con el código de salida");
		...
		m.put("Global Workspace Setting", "Configuración Global de Espacio de Trabajo");
		m.put("Gmail", "Gmail");
		...
		m.put("Header Name", "Nombre del Encabezado");
		m.put("Header Value", "Valor del Encabezado");
		...
		m.put("If enabled, the original JSON report (.osv-scanner-vulners.json) generated by Osv scanner will be published as artifact", 
			"Si está habilitado, el informe JSON original (.osv-scanner-vulners.json) generado por el escáner Osv se publicará como artefacto");
		m.put("If enabled, the original JSON report in .trivy-outputs generated by Trivy will be published as artifact", 
			"Si está habilitado, el informe JSON original en .trivy-outputs generado por Trivy se publicará como artefacto");
		...
		m.put("In case cache needs to be uploaded, this property specifies target project for the upload.\nLeave empty for current project", 
			"En caso de que se necesite cargar la caché, esta propiedad especifica el proyecto de destino para la carga.\nDéjelo vacío para el proyecto actual");
		...
		m.put("Issue Branch Prefix", "Prefijo de Rama de Problema");
		...
		m.put("Issue Summary Prompt", "Indicaciones para Resumen de Problema");
		...
		m.put("Issue branch prefix updated", "Prefijo de rama de problema actualizado");
		...
		m.put("Job workdir", "Espacio de trabajo de trabajo");
		m.put("Jobs", "Trabajos");
		...
		m.put("Kubernetes Provisioner", "Aprovisionador de Kubernetes");
		...
		m.put("Last Updated", "Última Actualización");
		...
		m.put("Lines", "Líneas");
		m.put("Link", "Enlace");
		m.put("Link / upload", "Enlazar / subir");
		...
		m.put("Log work", "Registrar trabajo");
		m.put("Login Command", "Comando de inicio de sesión");
		...
		m.put("Make sure to log in with an account that has package read permission for the project", 
			"Asegúrese de iniciar sesión con una cuenta que tenga permiso de lectura de paquetes para el proyecto");
		...
		m.put("Mark Resolved", "Marcar como resuelto");
		...
		m.put("Mark as resolved to confirm the deletion, or restore the file in terminal.", "Marcar como resuelto para confirmar la eliminación, o restaurar el archivo en la terminal.");
		...
		m.put("Maximum number of times this AI user can be awakened in a single event chain. When the limit is reached, the AI user will not run and a system comment will be posted instead", 
			"Número máximo de veces que este usuario de IA puede ser activado en una sola cadena de eventos. Cuando se alcanza el límite, el usuario de IA no se ejecutará y se publicará un comentario del sistema en su lugar");
		...
		m.put("Memory request for the workspace container.", "Solicitud de memoria para el contenedor del espacio de trabajo.");
		...
		m.put("Merge aborted", "Fusión abortada");
		...
		m.put("Merge if acceptable", "Fusionar si es aceptable");
		...
		m.put("Message is too long. Max {0} characters", "El mensaje es demasiado largo. Máximo {0} caracteres");
		m.put("Meta", "Meta");
		...
		m.put("Model", "Modelo");
		m.put("Modified by us, deleted by them", "Modificado por nosotros, eliminado por ellos");
		m.put("Month", "Mes");
		m.put("Months", "Meses");
		...
		m.put("My Workspace Data", "Datos de Mi Espacio de Trabajo");
		...
		m.put("Named Workspace Queries Bean", "Consultas de Espacio de Trabajo Nombradas Bean");
		m.put("Named Workspace Query", "Consulta de Espacio de Trabajo Nombrada");
		m.put("Namespace", "Espacio de nombres");
		...
		m.put("Next Iteration ({0})", "Siguiente Iteración ({0})");
		m.put("Next commit", "Siguiente commit");
		m.put("Next year", "El próximo año");
		...
		m.put("No changed files to commit", "No hay archivos modificados para confirmar");
		...
		m.put("No default fork root", "No hay raíz de bifurcación predeterminada");
		...
		m.put("No excluded files", "No hay archivos excluidos");
		...
		m.put("No exposed ports", "No hay puertos expuestos");
		...
		m.put("No provisioners defined. Workspaces will use auto-discovered provisioners instead", 
			"No se han definido provisionadores. Los espacios de trabajo usarán provisionadores auto-descubiertos en su lugar");
		...
		m.put("No workspaces", "No hay espacios de trabajo");
		m.put("No workspaces to delete", "No hay espacios de trabajo para eliminar");
		...
		m.put("Not configured", "No configurado");
		...
		m.put("Note", "Nota");
		m.put("Nothing changed yet", "Nada ha cambiado aún");
		...
		m.put("Optional instructions that define how the AI user should behave", "Instrucciones opcionales que definen cómo debe comportarse el usuario de IA");
		...
		m.put("Optionally define caches for the workspace. Cache populated by a workspace will be uploaded\nafter the workspace is deleted, and can be used by other workspaces created after it", 
			"Opcionalmente defina cachés para el espacio de trabajo. La caché poblada por un espacio de trabajo se cargará\ndespués de que el espacio de trabajo sea eliminado, y puede ser utilizada por otros espacios de trabajo creados después");
		m.put("Optionally define config files for the workspace", "Opcionalmente defina archivos de configuración para el espacio de trabajo");
		...
		m.put("Optionally define user data for the workspace. User data populated by a workspace will be uploaded\nafter the workspace is deleted, and can be reused by other workspaces created by same user", 
			"Opcionalmente defina datos de usuario para el espacio de trabajo. Los datos de usuario poblados por un espacio de trabajo se cargarán\ndespués de que el espacio de trabajo sea eliminado, y pueden ser reutilizados por otros espacios de trabajo creados por el mismo usuario");
		m.put("Optionally describe the group", "Opcionalmente describa el grupo");
		m.put("Optionally describe this workspace spec", "Describe opcionalmente esta especificación de espacio de trabajo");
		...
		m.put("Optionally mount directories or files under job working directory into container", "Opcionalmente monte directorios o archivos bajo el espacio de trabajo del trabajo dentro del contenedor");
		...
		m.put("Optionally specify <a href='https://github.com/tmux/tmux' target='_blank'>tmux</a> executable,\nfor instance <i>/usr/local/bin/tmux</i>. Leave empty to use tmux executable in PATH", 
			"Opcionalmente especifica el ejecutable de <a href='https://github.com/tmux/tmux' target='_blank'>tmux</a>,\npor ejemplo <i>/usr/local/bin/tmux</i>. Déjalo vacío para usar el ejecutable de tmux en PATH");
		...
		m.put("Optionally specify API key for authentication", "Opcionalmente, especifique la clave API para autenticación");
		m.put("Optionally specify CPU limit for the workspace container.", "Opcionalmente especifica el límite de CPU para el contenedor del espacio de trabajo.");
		m.put("Optionally specify Dockerfile relative to <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>. Leave empty to use file <tt>Dockerfile</tt> under build path specified above", 
			"Opcionalmente especifique el Dockerfile relativo al <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>espacio de trabajo del trabajo</a>. Déjelo vacío para usar el archivo <tt>Dockerfile</tt> bajo la ruta de construcción especificada anteriormente.");
		...
		m.put("Optionally specify a prefix to be prepended (as a path segment) when generate issue branch.\nFor instance with prefix <code>feature</code>, generated issue branch will be\n<code>feature/issue-100-some-title</code>", 
			"Opcionalmente especifique un prefijo para ser antepuesto (como un segmento de ruta) al generar la rama del problema.\nPor ejemplo, con el prefijo <code>feature</code>, la rama del problema generada será\n<code>feature/issue-100-some-title</code>");
		...
		m.put("Optionally specify a storage class to allocate the workspace PVC dynamically. Leave empty to use default storage class. <b class='text-warning'>NOTE:</b> Reclaim policy of the storage class should be set to <code>Delete</code>, as the volume will be deleted when the workspace is deleted", 
			"Opcionalmente, especifica una clase de almacenamiento para asignar dinámicamente el PVC del espacio de trabajo. Déjalo vacío para usar la clase de almacenamiento predeterminada. <b class='text-warning'>NOTA:</b> La política de recuperación de la clase de almacenamiento debe estar configurada en <code>Delete</code>, ya que el volumen se eliminará cuando se elimine el espacio de trabajo");
		...
		m.put("Optionally specify absolute path to the kubeconfig file used by kubectl to access the cluster. Leave empty to have kubectl determine cluster access automatically (works when OneDev itself runs in the cluster).", 
			"Opcionalmente especifica la ruta absoluta al archivo kubeconfig utilizado por kubectl para acceder al clúster. Déjalo vacío para que kubectl determine automáticamente el acceso al clúster (funciona cuando OneDev se ejecuta en el clúster).");
		m.put("Optionally specify absolute path to the kubectl executable. Leave empty to use kubectl from the system PATH.", 
			"Opcionalmente especifica la ruta absoluta al ejecutable de kubectl. Déjalo vacío para usar kubectl desde el PATH del sistema.");
		m.put("Optionally specify additional HTTP headers to include in the webhook POST request, for example an Authorization header required by the receiving endpoint", 
			"Opcionalmente especifique encabezados HTTP adicionales para incluir en la solicitud POST del webhook, por ejemplo, un encabezado de Autorización requerido por el punto de recepción");
		...
		m.put("Optionally specify applicable AI users to use this workspace spec for task automation. Leave empty to allow all AI users.\nWhen a AI user creates workspace to do its job, the first applicable spec will be used.", 
			"Especifica opcionalmente usuarios de IA aplicables para usar esta especificación de espacio de trabajo para la automatización de tareas. Déjalo vacío para permitir todos los usuarios de IA.\nCuando un usuario de IA crea un espacio de trabajo para realizar su trabajo, se usará la primera especificación aplicable.");
		...
		m.put("Optionally specify artifacts to retrieve from the dependency into <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>. Only published artifacts (via artifact publish step) can be retrieved. Leave empty to not retrieve any artifacts", 
			"Opcionalmente especifique artefactos para recuperar de la dependencia en el <a href='https://docs.onedev.io/concepts#job-workdir'>espacio de trabajo del trabajo</a>. Solo se pueden recuperar artefactos publicados (a través del paso de publicación de artefactos). Déjelo vacío para no recuperar ningún artefacto.");
		...
		m.put("Optionally specify build path relative to <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>. Leave empty to use job working directory itself", 
			"Opcionalmente especifique la ruta de construcción relativa al <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>espacio de trabajo del trabajo</a>. Déjelo vacío para usar el espacio de trabajo del trabajo en sí.");
		...
		m.put("Optionally specify container ports to expose. These ports will be mapped to random ports on host\nwhich will be displayed on the workspace page", 
			"Opcionalmente especifique puertos de contenedor para exponer. Estos puertos se mapearán a puertos aleatorios en el host\nque se mostrarán en la página del espacio de trabajo");
		...
		m.put("Optionally specify cpu limit for workspace containers. This will be used as option <a href='https://docs.docker.com/config/containers/resource_constraints/#cpu' target='_blank'>--cpus</a> of the container", 
			"Opcionalmente especifique el límite de CPU para los contenedores del espacio de trabajo. Esto se usará como opción <a href='https://docs.docker.com/config/containers/resource_constraints/#cpu' target='_blank'>--cpus</a> del contenedor");
		...
		m.put("Optionally specify custom fields allowed to edit", "Opcionalmente, especifica campos personalizados permitidos para editar");
		...
		m.put("Optionally specify directories or files relative to cache path to exclude.\nUse '**', '*' or '?' for <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>.\nMultiple excludes should be separated by space, and single exclude containing space should be quoted", 
			"Especifica opcionalmente directorios o archivos relativos a la ruta de caché para excluir.\nUsa '**', '*' o '?' para <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>.\nMúltiples exclusiones deben separarse por espacio, y una sola exclusión que contenga espacio debe estar entre comillas");
		m.put("Optionally specify directories or files relative to data path to exclude.\nUse '**', '*' or '?' for <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>.\nMultiple excludes should be separated by space, and single exclude containing space should be quoted", 
			"Especifica opcionalmente directorios o archivos relativos a la ruta de datos para excluir.\nUsa '**', '*' o '?' para <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>.\nMúltiples exclusiones deben separarse por espacio, y una sola exclusión que contenga espacio debe estar entre comillas");
		...
		m.put("Optionally specify files or directories relative to cache path to exclude.\nUse '**', '*' or '?' for <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>.\nMultiple excludes should be separated by space, and single exclude containing space should be quoted", 
			"Especifica opcionalmente archivos o directorios relativos a la ruta de caché para excluir.\nUsa '**', '*' o '?' para <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>.\nMúltiples exclusiones deben separarse por espacio, y una sola exclusión que contenga espacio debe estar entre comillas");
		m.put("Optionally specify files to be excluded when reviewing code with AI user to save tokens", 
			"Opcionalmente especifique archivos para excluir al revisar código con usuario de IA para ahorrar tokens");
		m.put("Optionally specify files to compute checksum from. This is useful when your project\nhas lock files (package-lock.json, pom.xml, etc.) that represent cache state. When\nchecksum changes, cache can still be loaded as a partial match, but\nwill be re-uploaded with the new checksum if upload strategy is set to <i>Upload If Not Exact Match</i>.\nUse '**', '*' or '?' for <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>.\nMultiple files should be separated by space, and single file containing space should be quoted.\nNon-absolute file is relative to <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>.<br>\n<b>NOTE: </b> An empty checksum is assumed if this property is empty.", 
			"Opcionalmente especifique archivos para calcular el checksum. Esto es útil cuando su proyecto\ntiene archivos de bloqueo (package-lock.json, pom.xml, etc.) que representan el estado de la caché. Cuando\nel checksum cambia, la caché aún puede cargarse como una coincidencia parcial, pero\nse volverá a cargar con el nuevo checksum si la estrategia de carga está configurada en <i>Cargar si no es coincidencia exacta</i>.\nUse '**', '*' o '?' para <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>.\nMúltiples archivos deben ser separados por espacio, y un solo archivo que contenga espacio debe ser citado.\nUn archivo no absoluto es relativo al <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>directorio de trabajo del trabajo</a>.<br>\n<b>NOTA: </b> Se asume un checksum vacío si esta propiedad está vacía.");
		...
		m.put("Optionally specify issues applicable for this transition in same project as the branch. Leave empty for all issues", 
			"Opcionalmente, especifique los problemas aplicables para esta transición en el mismo proyecto que la rama. Déjelo vacío para todos los problemas");
		m.put("Optionally specify issues applicable for this transition in same project as the build. Leave empty for all issues", 
			"Opcionalmente, especifique los problemas aplicables para esta transición en el mismo proyecto que la compilación. Déjelo vacío para todos los problemas");
		m.put("Optionally specify issues applicable for this transition in same project as the pull request. Leave empty for all issues", 
			"Opcionalmente, especifique los problemas aplicables para esta transición en el mismo proyecto que la solicitud de extracción. Déjelo vacío para todos los problemas");
		...
		m.put("Optionally specify list of shortcuts at top of workspace. When workspace is created,\nthe first shortcut will be opened automatically", 
			"Opcionalmente especifique una lista de accesos directos en la parte superior del espacio de trabajo. Cuando se crea el espacio de trabajo,\nel primer acceso directo se abrirá automáticamente");
		...
		m.put("Optionally specify memory limit for the workspace container.", "Opcionalmente especifica el límite de memoria para el contenedor del espacio de trabajo.");
		m.put("Optionally specify memory limit for workspace containers. This will be used as option <a href='https://docs.docker.com/config/containers/resource_constraints/#memory' target='_blank'>--memory</a> of the container", 
			"Opcionalmente especifique el límite de memoria para los contenedores del espacio de trabajo. Esto se usará como opción <a href='https://docs.docker.com/config/containers/resource_constraints/#memory' target='_blank'>--memory</a> del contenedor");
		...
		m.put("Optionally specify path relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>", 
			"Opcionalmente especifique la ruta relativa al <a href='https://docs.onedev.io/concepts#job-workdir'>espacio de trabajo del trabajo</a> para usar como archivo de ignorar de trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>.");
		m.put("Optionally specify path relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a> to be used as trivy <a href='https://trivy.dev/docs/latest/scanner/secret/#configuration' target='_blank'>secret config</a>", 
			"Opcionalmente especifique la ruta relativa al <a href='https://docs.onedev.io/concepts#job-workdir'>espacio de trabajo del trabajo</a> para ser usada como <a href='https://trivy.dev/docs/latest/scanner/secret/#configuration' target='_blank'>configuración de secretos</a> de trivy");
		m.put("Optionally specify path relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a> to publish artifacts from. Leave empty to use job working directory itself", 
			"Opcionalmente especifique la ruta relativa al <a href='https://docs.onedev.io/concepts#job-workdir'>espacio de trabajo del trabajo</a> para publicar artefactos. Déjelo vacío para usar el espacio de trabajo del trabajo en sí.");
		...
		m.put("Optionally specify projects applicable for this provisioner. Use '**', '*' or '?' for <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Multiple projects should be separated by space", 
			"Opcionalmente especifique proyectos aplicables para este provisionador. Use '**', '*' o '?' para <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Múltiples proyectos deben estar separados por espacio");
		...
		m.put("Optionally specify registry logins to override those defined in workspace provisioner.\nFor built-in registry, use <code>@server_url@</code> for registry url,\n<code>@workspace_token@</code> for user name, and access token for password\n", 
			"Opcionalmente especifique inicios de sesión de registro para anular los definidos en el aprovisionador del espacio de trabajo.\nPara el registro incorporado, use <code>@server_url@</code> para la URL del registro,\n<code>@workspace_token@</code> para el nombre de usuario, y el token de acceso para la contraseña\n");
		...
		m.put("Optionally specify relative path under <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a> to clone code into. Leave empty to use job working directory itself", 
			"Opcionalmente especifique la ruta relativa bajo el <a href='https://docs.onedev.io/concepts#job-workdir'>espacio de trabajo del trabajo</a> para clonar el código. Déjelo vacío para usar el espacio de trabajo del trabajo en sí.");
		m.put("Optionally specify relative path under <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a> to scan. Leave empty to use job working directory itself", 
			"Opcionalmente especifique la ruta relativa bajo el <a href='https://docs.onedev.io/concepts#job-workdir'>espacio de trabajo del trabajo</a> para escanear. Déjelo vacío para usar el espacio de trabajo del trabajo en sí.");
		...
		m.put("POSIX Compatible Shell", "Shell compatible con POSIX");
		...
		m.put("Performing fuzzy query. Enclose search text with '~' to add more conditions, for instance: ~branch name~ and \"Status\" is \"STARTED\"", 
			"Realizando consulta difusa. Encierre el texto de búsqueda con '~' para agregar más condiciones, por ejemplo: ~nombre de rama~ y \"Estado\" es \"INICIADO\"");
		...
		m.put("Please reprovision the workspace to show changes", "Por favor, vuelve a aprovisionar el espacio de trabajo para mostrar los cambios");
		...
		m.put("Please select workspaces to delete", "Por favor seleccione espacios de trabajo para eliminar");
		...
		m.put("PowerShell Executable", "Ejecutable de PowerShell");
		...
		m.put("Previous year", "Año anterior");
		...
		m.put("Project Ai Setting", "Configuración de AI del Proyecto");
		...
		m.put("Project Workspace Setting", "Configuración del Espacio de Trabajo del Proyecto");
		...
		m.put("Prompt to use when creating an issue for a failed build. Display language will be appended automatically", 
			"Indicaciones para usar al crear un problema para una construcción fallida. El idioma de visualización se añadirá automáticamente");
		m.put("Prompt to use when explaining highlighted code. Display language will be appended automatically", 
			"Indicaciones para usar al explicar el código resaltado. El idioma de visualización se añadirá automáticamente");
		m.put("Prompt to use when summarizing issue comments. Display language will be appended automatically", 
			"Indicaciones para usar al resumir comentarios de problemas. El idioma de visualización se añadirá automáticamente");
		m.put("Prompt to use when summarizing pull request comments. Display language will be appended automatically", 
			"Indicaciones para usar al resumir comentarios de solicitudes de extracción. El idioma de visualización se añadirá automáticamente");
		...
		m.put("Publish JSON Report As Artifact", "Publicar Informe JSON Como Artefacto");
		...
		m.put("Published site", "Sitio publicado");
		m.put("Pull", "Extraer");
		m.put("Pull Command", "Comando de extracción");
		m.put("Pull Image", "Extraer imagen");
		m.put("Pull Request", "Solicitud de extracción");
		m.put("Pull Request Assignee Responsibilities", "Responsabilidades del asignado al Pull Request");
		...
		m.put("Pull Request Summary Prompt", "Indicaciones para Resumen de Solicitud de Extracción");
		...
		m.put("Pull request cannot be merged now as valid signature is required for head commit", "La solicitud de extracción no se puede fusionar ahora ya que se requiere una firma válida para el commit principal");
		...
		m.put("Pull request is opened or updated", "Se abre o actualiza una solicitud de extracción");
		...
		m.put("Pull successful", "Extracción exitosa");
		m.put("Push", "Empujar");
		...
		m.put("Push successful", "Empuje exitoso");
		...
		m.put("Query/order workspaces", "Consultar/ordenar espacios de trabajo");
		...
		m.put("Reference Workspace", "Espacio de Trabajo de Referencia");
		...
		m.put("Remote Docker Provisioner", "Aprovisionador de Docker Remoto");
		m.put("Remote Machine", "Máquina remota");
		m.put("Remote Shell Executor", "Ejecutor de shell remoto");
		m.put("Remote Shell Provisioner", "Aprovisionador de Shell Remoto");
		...
		m.put("Remove all queried agents. Type <code>remove ALL agents</code> below to confirm", "Elimina todos los agentes consultados. Escribe <code>remove ALL agents</code> abajo para confirmar");
		...
		m.put("Remove selected agents. Type <code>yes</code> below to confirm", "Elimina los agentes seleccionados. Escribe <code>yes</code> abajo para confirmar");
		...
		m.put("Request review again", "Solicitar revisión nuevamente");
		...
		m.put("Responsibilities of the AI user when assigned to a pull request", "Responsabilidades del usuario de IA cuando se le asigna un pull request");
		...
		m.put("Revert to Default", "Restablecer a Predeterminado");
		...
		m.put("STAGED", "ETAPADO");
		m.put("SUCCESSFUL", "EXITOSO.");
		m.put("Save", "Guardar.");
		m.put("Save Prompt", "Guardar Mensaje");
		...
		m.put("Select Spec", "Seleccionar Especificación");
		m.put("Select a file to view changes", "Seleccione un archivo para ver los cambios");
		...
		m.put("Server Docker Provisioner", "Aprovisionador de Docker del Servidor");
		...
		m.put("Server Shell Provisioner", "Aprovisionador de Shell del Servidor");
		...
		m.put("Setup Commands", "Comandos de Configuración");
		...
		m.put("Shell", "Shell");
		m.put("Shell Executable", "Ejecutable de Shell");
		m.put("Shortcut Config", "Configuración de Atajo");
		m.put("Shortcuts", "Atajos");
		m.put("Show / Create", "Mostrar / Crear");
		...
		m.put("Show Language Stats", "Mostrar Estadísticas de Idioma");
		m.put("Show Next Iteration", "Mostrar Siguiente Iteración");
		...
		m.put("Show Workspace Stats", "Mostrar Estadísticas del Espacio de Trabajo");
		...
		m.put("Show in workspace list", "Mostrar en la lista de espacios de trabajo");
		...
		m.put("Some local changes would be overwritten by merge", "Algunos cambios locales serían sobrescritos por la fusión");
		...
		m.put("Someone changed file mode since you started editing", "Alguien cambió el modo del archivo desde que comenzó a editar");
		m.put("Someone changed file type since you started editing", "Alguien cambió el tipo de archivo desde que comenzó a editar");
		...
		m.put("Specifies who can access this AI service. AI service can be accessed in below approaches:", 
			"Especifica quién puede acceder a este servicio de IA. El servicio de IA se puede acceder de las siguientes maneras:");
		m.put("Specify .net TRX test result file relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, for instance <tt>TestResults/*.trx</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de resultados de prueba .net TRX relativo a <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, por ejemplo <tt>TestResults/*.trx</tt>. Usa * o ? para coincidencia de patrones");
		...
		m.put("Specify ESLint report file in checkstyle format under <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>. This file can be generated with ESLint option <tt>'-f checkstyle'</tt> and <tt>'-o'</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de informe ESLint en formato checkstyle bajo <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>. Este archivo puede generarse con la opción de ESLint <tt>'-f checkstyle'</tt> y <tt>'-o'</tt>. Usa * o ? para coincidencia de patrones");
		...
		m.put("Specify JUnit test result file in XML format relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, for instance <tt>target/surefire-reports/TEST-*.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de resultados de prueba JUnit en formato XML relativo a <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, por ejemplo <tt>target/surefire-reports/TEST-*.xml</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify JaCoCo coverage xml report file relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, for instance, <tt>target/site/jacoco/jacoco.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de informe de cobertura xml de JaCoCo relativo a <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, por ejemplo, <tt>target/site/jacoco/jacoco.xml</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify Jest coverage report file in clover format relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, for instance <tt>coverage/clover.xml</tt>. This file can be generated with Jest option <tt>'--coverage'</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de informe de cobertura de Jest en formato clover relativo a <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, por ejemplo <tt>coverage/clover.xml</tt>. Este archivo puede generarse con la opción de Jest <tt>'--coverage'</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify Jest test result file in json format relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>. This file can be generated via Jest option <tt>'--json'</tt> and <tt>'--outputFile'</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de resultados de prueba de Jest en formato json relativo a <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>. Este archivo puede generarse mediante la opción de Jest <tt>'--json'</tt> y <tt>'--outputFile'</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify OCI layout directory of the image to scan. This directory can be generated via build image step or pull image step. It should be relative to <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>", 
			"Especifica el directorio de diseño OCI de la imagen para escanear. Este directorio puede generarse mediante el paso de construcción de imagen o el paso de extracción de imagen. Debe ser relativo a <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>");
		m.put("Specify OCI layout directory relative to <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a> to push from", 
			"Especifica el directorio de diseño OCI relativo a <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a> para realizar el push");
		...
		m.put("Specify PMD result xml file relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, for instance, <tt>target/pmd.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo xml de resultados de PMD relativo a <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, por ejemplo, <tt>target/pmd.xml</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify POSIX shell executable to be used", "Especifica el ejecutable de shell POSIX a utilizar");
		m.put("Specify PowerShell commands to execute under the <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>.<br><b class='text-warning'>NOTE: </b> OneDev checks exit code of the script to determine if step is successful. Since PowerShell always exit with 0 even if there are script errors, you should handle errors in the script and exit with non-zero code, or add line <code>$ErrorActionPreference = &quot;Stop&quot;</code> at start of your script<br>", 
			"Especifica los comandos de PowerShell para ejecutar bajo <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>.<br><b class='text-warning'>NOTA: </b> OneDev verifica el código de salida del script para determinar si el paso es exitoso. Dado que PowerShell siempre sale con 0 incluso si hay errores en el script, deberías manejar los errores en el script y salir con un código distinto de cero, o agregar la línea <code>$ErrorActionPreference = &quot;Stop&quot;</code> al inicio de tu script<br>");
		m.put("Specify Roslynator diagnostics output file in XML format relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>. This file can be generated with <i>-o</i> option. Use * or ? for pattern match", 
			"Especifica el archivo de salida de diagnósticos de Roslynator en formato XML relativo a <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>. Este archivo puede generarse con la opción <i>-o</i>. Usa * o ? para coincidencia de patrones");
		...
		m.put("Specify SpotBugs result xml file relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, for instance, <tt>target/spotbugsXml.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo xml de resultados de SpotBugs relativo a <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, por ejemplo, <tt>target/spotbugsXml.xml</tt>. Usa * o ? para coincidencia de patrones");
		...
		m.put("Specify a <a href='https://docs.onedev.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a>\nwhose value is an access token with upload cache permission for above project.\nNote that this property is not required if upload cache to current or child\nproject and build commit is reachable from default branch", 
			"Especifique un <a href='https://docs.onedev.io/tutorials/cicd/job-secrets' target='_blank'>secreto de trabajo</a>\ncuyo valor es un token de acceso con permiso para cargar caché para el proyecto anterior.\nTenga en cuenta que esta propiedad no es necesaria si se carga la caché al proyecto actual o hijo\ny el commit de construcción es alcanzable desde la rama predeterminada");
		...
		m.put("Specify a Container Image to Test Against", "Especifica una Imagen de Contenedor para Probar");
		...
		m.put("Specify a name to identify this workspace spec", "Especifique un nombre para identificar esta especificación de espacio de trabajo");
		...
		m.put("Specify access token with upload cache permission for above project.\nNote that this property is not required if upload cache to current project", 
			"Especifique un token de acceso con permiso para cargar caché para el proyecto anterior.\nTenga en cuenta que esta propiedad no es necesaria si se carga la caché al proyecto actual");
		...
		m.put("Specify agents applicable for this provisioner", "Especifica los agentes aplicables para este aprovisionador");
		...
		m.put("Specify applicable jobs of this executor.\n<b class='text-danger'>WARNING</b>: Jobs running with this executor has same privilege as OneDev process.\nPlease make sure that only trusted jobs can use this executor", 
			"Especifique los trabajos aplicables de este ejecutor.\n<b class='text-danger'>ADVERTENCIA</b>: Los trabajos que se ejecutan con este ejecutor tienen el mismo privilegio que el proceso de OneDev.\nPor favor, asegúrese de que solo trabajos de confianza puedan usar este ejecutor");
		...
		m.put("Specify artifacts to retrieve into <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>. Only published artifacts (via artifact publish step) can be retrieved.", 
			"Especifica artefactos para recuperar en <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>. Solo se pueden recuperar artefactos publicados (mediante el paso de publicación de artefactos).");
		...
		m.put("Specify batch commands to execute under the <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>", 
			"Especifica comandos batch para ejecutar en el <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>directorio de trabajo del trabajo</a>");
		...
		m.put("Specify cache entries", "Especifica entradas de caché");
		m.put("Specify cache path. Non-absolute path is considered to be relative to\n<a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>.\nNote that shell related executors runs directly on host machine, and only accept relative paths", 
			"Especifica la ruta de caché. Una ruta no absoluta se considera relativa a\n<a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>el directorio de trabajo del trabajo</a>.\nTen en cuenta que los ejecutores relacionados con shell se ejecutan directamente en la máquina host y solo aceptan rutas relativas");
		m.put("Specify cache path. Non-absolute path is considered to be relative to working directory.\nNote that shell related executors only accept relative paths", 
			"Especifica la ruta de caché. Una ruta no absoluta se considera relativa al directorio de trabajo.\nTen en cuenta que los ejecutores relacionados con shell solo aceptan rutas relativas");
		m.put("Specify cache upload strategy after build successful. <i>Upload If Not Exact Match</i>\nmeans to upload when no cache found with matching key and checksum , and\n<i>Upload If Changed</i> means to upload if some files in cache path are changed", 
			"Especifique la estrategia de carga de caché después de que la construcción sea exitosa. <i>Cargar si no es coincidencia exacta</i>\nsignifica cargar cuando no se encuentra caché con clave y checksum coincidentes, y\n<i>Cargar si ha cambiado</i> significa cargar si algunos archivos en la ruta de caché han cambiado");
		...
		m.put("Specify clover coverage xml report file relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, for instance, <tt>target/site/clover/clover.xml</tt>. Refer to <a href='https://openclover.org/documentation'>OpenClover documentation</a> on how to generate clover xml file. Use * or ? for pattern match", 
			"Especifica el archivo de informe de cobertura xml de clover relativo a <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, por ejemplo, <tt>target/site/clover/clover.xml</tt>. Consulta la <a href='https://openclover.org/documentation'>documentación de OpenClover</a> sobre cómo generar el archivo xml de clover. Usa * o ? para coincidencia de patrones");
		m.put("Specify cobertura coverage xml report file relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, for instance, <tt>target/site/cobertura/coverage.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de informe de cobertura xml de cobertura relativo a <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, por ejemplo, <tt>target/site/cobertura/coverage.xml</tt>. Usa * o ? para coincidencia de patrones");
		...
		m.put("Specify container image to create workspace inside. Note that this image should\nhave <a href='https://git-scm.com' target='_blank'>git</a>, <a href='https://git-lfs.com' target='_blank'>git-lfs</a>, <a href='https://curl.se' target='_blank'>curl</a>, and <a href='https://github.com/tmux/tmux' target='_blank'>tmux</a> installed\n", 
			"Especifique la imagen del contenedor para crear el espacio de trabajo dentro. Tenga en cuenta que esta imagen debe\ntener <a href='https://git-scm.com' target='_blank'>git</a>, <a href='https://git-lfs.com' target='_blank'>git-lfs</a>, <a href='https://curl.se' target='_blank'>curl</a>, y <a href='https://github.com/tmux/tmux' target='_blank'>tmux</a> instalados\n");
		...
		m.put("Specify content of the config file", "Especifique el contenido del archivo de configuración");
		m.put("Specify cppcheck xml result file relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>. This file can be generated with cppcheck xml output option, for instance <code>cppcheck src --xml 2>check-result.xml</code>. Use * or ? for pattern match", 
			"Especifique el archivo de resultados xml de cppcheck relativo al <a href='https://docs.onedev.io/concepts#job-workdir'>espacio de trabajo del trabajo</a>. Este archivo puede generarse con la opción de salida xml de cppcheck, por ejemplo <code>cppcheck src --xml 2>check-result.xml</code>. Use * o ? para coincidencia de patrones");
		...
		m.put("Specify data entries to persist across workspaces", "Especifica entradas de datos para persistir entre espacios de trabajo");
		m.put("Specify data path to persist across workspaces. Only absolute path is accepted", "Especifica la ruta de datos para persistir entre espacios de trabajo. Solo se acepta una ruta absoluta");
		...
		m.put("Specify directory relative to <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a> to store OCI layout", 
			"Especifique el directorio relativo al <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>espacio de trabajo del trabajo</a> para almacenar el diseño OCI");
		...
		m.put("Specify how coding agents should reference an issue in commit messages when the commit is intended to fix an issue", 
			"Especifica cómo los agentes de codificación deben referenciar un problema en los mensajes de commit cuando el commit está destinado a corregir un problema");
		...
		m.put("Specify markdown file relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a> to be published", 
			"Especifique el archivo markdown relativo al <a href='https://docs.onedev.io/concepts#job-workdir'>espacio de trabajo del trabajo</a> para publicar");
		...
		m.put("Specify max number of workspaces this provisioner can run concurrently on each matched agent. Leave empty to set as agent CPU cores", 
			"Especifica el número máximo de espacios de trabajo que este aprovisionador puede ejecutar simultáneamente en cada agente coincidente. Déjalo vacío para establecerlo como los núcleos de CPU del agente.");
		m.put("Specify max number of workspaces this provisioner can run on each matched agent. Leave empty to set as agent CPU cores", 
			"Especifica el número máximo de espacios de trabajo que este aprovisionador puede ejecutar en cada agente coincidente. Déjalo vacío para establecerlo como los núcleos de CPU del agente.");
		...
		m.put("Specify password or access token of the registry", "Especifique la contraseña o el token de acceso del registro");
		...
		m.put("Specify path to the config file. Only absolute path is accepted", "Especifique la ruta al archivo de configuración. Solo se acepta la ruta absoluta");
		...
		m.put("Specify prefix/suffix patterns to detect fixed issues in commit messages. Each line of the commit message will be matched against each entry defined here", 
			"Especifica patrones de prefijo/sufijo para detectar problemas corregidos en los mensajes de commit. Cada línea del mensaje de commit será comparada con cada entrada definida aquí");
		...
		m.put("Specify registry logins if necessary. For built-in registry, use <code>@server_url@</code> for registry url, <code>@workspace_token@</code> for user name, and access token for password.", 
			"Especifica los inicios de sesión del registro si es necesario. Para el registro integrado, usa <code>@server_url@</code> para la URL del registro, <code>@workspace_token@</code> para el nombre de usuario y el token de acceso como contraseña.");
		...
		m.put("Specify relative path under <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a> to store OCI layout", 
			"Especifique la ruta relativa bajo el <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>espacio de trabajo del trabajo</a> para almacenar el diseño OCI");
		...
		m.put("Specify shell commands to execute under the <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>", 
			"Especifique los comandos shell para ejecutar bajo el <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>espacio de trabajo del trabajo</a>");
		...
		m.put("Specify start page of the report relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, for instance: <tt>manual/index.md</tt>", 
			"Especifique la página de inicio del informe relativa al <a href='https://docs.onedev.io/concepts#job-workdir'>espacio de trabajo del trabajo</a>, por ejemplo: <tt>manual/index.md</tt>");
		m.put("Specify start page of the report relative to <a href='https://docs.onedev.io/concepts#job-workdir'>job working directory</a>, for instance: api/index.html", 
			"Especifique la página de inicio del informe relativa al <a href='https://docs.onedev.io/concepts#job-workdir'>espacio de trabajo del trabajo</a>, por ejemplo: api/index.html");
		...
		m.put("Specify storage size to request for the workspace PVC. The size should conform to <a href='https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#setting-requests-and-limits-for-local-ephemeral-storage' target='_blank'>Kubernetes resource capacity format</a>, for instance <i>10Gi</i>", 
			"Especifica el tamaño de almacenamiento para solicitar el PVC del espacio de trabajo. El tamaño debe cumplir con el <a href='https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#setting-requests-and-limits-for-local-ephemeral-storage' target='_blank'>formato de capacidad de recursos de Kubernetes</a>, por ejemplo <i>10Gi</i>");
		...
		m.put("Specify the code privilege for the role. The Write permission implies CreateWorkspaces permission", 
			"Especifica el privilegio de código para el rol. El permiso de Escritura implica el permiso de CrearEspaciosDeTrabajo");
		...
		m.put("Specify the kubernetes namespace to host workspaces of this provisioner. OneDev creates the namespace if it does not yet exist.", 
			"Especifica el espacio de nombres de Kubernetes para alojar los espacios de trabajo de este aprovisionador. OneDev crea el espacio de nombres si aún no existe.");
		...
		m.put("Sync successful", "Sincronización exitosa");
		...
		m.put("System Prompt", "Aviso del sistema");
		...
		m.put("Then add the package", "Luego agrega el paquete");
		...
		m.put("Then publish package to the registry", "Luego publica el paquete en el registro");
		...
		m.put("This executor runs build jobs with OneDev server's shell facility", "Este ejecutor ejecuta trabajos de construcción con la facilidad de shell del servidor OneDev");
		m.put("This executor runs build jobs with remote machines's shell facility via <a href='/~administration/agents' target='_blank'>agents</a>", 
			"Este ejecutor ejecuta trabajos de construcción con la facilidad de shell de máquinas remotas a través de <a href='/~administration/agents' target='_blank'>agentes</a>");
		...
		m.put("This is a built-in role and cannot be deleted", "Este es un rol integrado y no se puede eliminar");
		...
		m.put("This key will be used to identify the cache in project hierarchy (search from current\nproject to root project in order), together with checksum (see below). An exact match\nmeans that both key and checksum match, and a partial match means that only key\nmatches", 
			"Esta clave se usará para identificar la caché en la jerarquía del proyecto (buscar desde el\nproyecto actual hasta el proyecto raíz en orden), junto con el checksum (ver abajo). Una coincidencia exacta\nsignifica que tanto la clave como el checksum coinciden, y una coincidencia parcial significa que solo la clave\ncoincide");
		...
		m.put("This name has already been used by another workspace provisioner", "Este nombre ya ha sido utilizado por otro aprovisionador de espacios de trabajo");
		...
		m.put("This provisioner creates workspaces as pods inside Kubernetes cluster", "Este provisionador crea espacios de trabajo como pods dentro del clúster de Kubernetes");
		m.put("This provisioner creates workspaces inside Docker containers on OneDev server", "Este provisionador crea espacios de trabajo dentro de contenedores Docker en el servidor de OneDev");
		m.put("This provisioner creates workspaces inside Docker containers on remote machine via\n<a href='/~administration/agents' target='_blank'>agents</a>.", 
			"Este provisionador crea espacios de trabajo dentro de contenedores Docker en una máquina remota a través de\n<a href='/~administration/agents' target='_blank'>agentes</a>.");
		...
		m.put("This provisioner creates workspaces with remote agents' shell facility, and requires tmux to be installed on matched agents", 
			"Este provisionador crea espacios de trabajo con la funcionalidad de shell de agentes remotos, y requiere que tmux esté instalado en los agentes coincidentes");
		...
		m.put("This setting is inherited from parent project when left empty. The first non-empty value found while walking up the project hierarchy will be used.", 
			"Esta configuración se hereda del proyecto padre cuando se deja vacía. Se usará el primer valor no vacío encontrado al recorrer la jerarquía del proyecto.");
		...
		m.put("This step can only be executed by a docker aware executor. It runs under <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>job working directory</a>", 
			"Este paso solo puede ser ejecutado por un ejecutor compatible con Docker. Se ejecuta bajo <a href='https://docs.onedev.io/concepts#job-workdir' target='_blank'>el espacio de trabajo del trabajo</a>");
		...
		m.put("This terminal is read only", "Este terminal es de solo lectura");
		...
		m.put("Type", "Tipo");
		m.put("Type <code>delete ALL builds</code> below to delete all queried builds", "Escriba <code>delete ALL builds</code> abajo para eliminar todas las compilaciones consultadas");
		m.put("Type <code>delete ALL comments</code> below to delete all queried comments", "Escriba <code>delete ALL comments</code> abajo para eliminar todos los comentarios consultados");
		m.put("Type <code>delete ALL issues</code> below to delete all queried issues", "Escriba <code>delete ALL issues</code> abajo para eliminar todos los problemas consultados");
		m.put("Type <code>delete ALL packages</code> below to delete all queried packages", "Escriba <code>delete ALL packages</code> abajo para eliminar todos los paquetes consultados");
		m.put("Type <code>delete ALL projects</code> below to delete all queried projects", "Escriba <code>delete ALL projects</code> abajo para eliminar todos los proyectos consultados");
		m.put("Type <code>delete ALL pull requests</code> below to delete all queried pull requests", 
			"Escriba <code>delete ALL pull requests</code> abajo para eliminar todas las solicitudes de extracción consultadas");
		m.put("Type <code>delete ALL users</code> below to delete all queried users", "Escriba <code>delete ALL users</code> abajo para eliminar todos los usuarios consultados");
		m.put("Type <code>delete ALL workspaces</code> below to delete all queried workspaces", "Escriba <code>delete ALL workspaces</code> abajo para eliminar todos los espacios de trabajo consultados");
		...
		m.put("Type <code>yes</code> below to delete selected workspaces", "Escriba <code>yes</code> abajo para eliminar los espacios de trabajo seleccionados");
		...
		m.put("Type to filter...", "Escriba para filtrar...");
		m.put("Type your message (shift+enter for new line)", "Escribe tu mensaje (shift+enter para nueva línea)");
		m.put("UNSTAGED", "NO ESCENIFICADO");
		m.put("URL", "URL");
		...
		m.put("Unable to delete issue \"{0}\" as it has workspaces", "No se puede eliminar el problema \"{0}\" ya que tiene espacios de trabajo");
		m.put("Unable to delete pull request \"{0}\" as it has workspaces", "No se puede eliminar la solicitud de extracción \"{0}\" ya que tiene espacios de trabajo");
		...
		m.put("Unable to read file from the working directory. Please resolve this conflict in the terminal and then mark as resolved.", 
			"No se puede leer el archivo desde el directorio de trabajo. Por favor, resuelva este conflicto en el terminal y luego márquelo como resuelto.");
		...
		m.put("Unresolved comments", "Comentarios no resueltos");
		m.put("Unresolved comments with unviewed activity", "Comentarios no resueltos con actividad no vista");
		...
		m.put("Unstage", "Desescenificar");
		m.put("Unstage All", "Desescenificar Todo");
		...
		m.put("Upload", "Subir");
		m.put("Upload Access Token", "Subir Token de Acceso");
		...
		m.put("Use '*' or '?' for wildcard match", "Use '*' o '?' para coincidencia de comodines");
		...
		m.put("User Data", "Datos del Usuario");
		m.put("User Data Entry", "Entrada de datos del usuario");
		...
		m.put("Via mention in issue or pull request comments", "A través de menciones en comentarios de problemas o solicitudes de extracción");
		m.put("View", "Ver");
		...
		m.put("When forking from the UI, the default target project will be created as\n&lt;default fork root&gt;/&lt;account name&gt;/&lt;project name&gt; if specified\n(users forking need permission to create child projects under the fork\nroot), or &lt;account name&gt;/&lt;project name&gt; otherwise (need permission\nto create root projects)", 
			"Al hacer fork desde la interfaz de usuario, el proyecto de destino predeterminado se creará como\n&lt;raíz de fork predeterminada&gt;/&lt;nombre de cuenta&gt;/&lt;nombre de proyecto&gt; si se especifica\n(los usuarios que hagan fork necesitan permiso para crear proyectos secundarios bajo la raíz de fork\n), o &lt;nombre de cuenta&gt;/&lt;nombre de proyecto&gt; de lo contrario (necesitan permiso\npara crear proyectos raíz)");
		...
		m.put("Whether or not the value is secret", "Si el valor es secreto o no");
		...
		m.put("Whether or not this script can be used in workspace spec", "Si este script puede ser usado en la especificación del espacio de trabajo o no");
		...
		m.put("Windows Batch", "Batch de Windows");
		...
		m.put("Workspace Data", "Datos del Espacio de Trabajo");
		m.put("Workspace Management", "Gestión del Espacio de Trabajo");
		m.put("Workspace Notification", "Notificación del Espacio de Trabajo");
		m.put("Workspace Notification Template", "Plantilla de Notificación del Espacio de Trabajo");
		m.put("Workspace Provisioner", "Aprovisionador del Espacio de Trabajo");
		m.put("Workspace Provisioner Bean", "Bean del Aprovisionador del Espacio de Trabajo");
		m.put("Workspace Provisioners", "Aprovisionadores del Espacio de Trabajo");
		m.put("Workspace Shell", "Shell del Espacio de Trabajo");
		m.put("Workspace Spec", "Especificación del Espacio de Trabajo");
		m.put("Workspace Spec Template", "Plantilla de Especificación del Espacio de Trabajo");
		m.put("Workspace Specs", "Especificaciones del Espacio de Trabajo");
		m.put("Workspace Volume Storage Class", "Clase de Almacenamiento del Volumen del Espacio de Trabajo");
		m.put("Workspace Volume Storage Size", "Tamaño de Almacenamiento del Volumen del Espacio de Trabajo");
		m.put("Workspace administrative permission inside a project, including batch operations\nover multiple workspaces including batch operations over multiple workspaces.\nThis permission implies WriteCode permission.", 
			"Permiso administrativo de espacio de trabajo dentro de un proyecto, incluyendo operaciones batch\nsobre múltiples espacios de trabajo incluyendo operaciones batch sobre múltiples espacios de trabajo.\nEste permiso implica el permiso de EscribirCódigo.");
		m.put("Workspace data deleted", "Datos del espacio de trabajo eliminados");
		m.put("Workspace not exist or access denied", "El espacio de trabajo no existe o el acceso está denegado");
		m.put("Workspace not found", "Espacio de trabajo no encontrado");
		m.put("Workspace number", "Número del espacio de trabajo");
		m.put("Workspace provisioners", "Aprovisionadores del espacio de trabajo");
		m.put("Workspace reprovisioning requested", "Reaprovisionamiento del espacio de trabajo solicitado");
		m.put("Workspace token", "Token del espacio de trabajo");
		m.put("Workspace {0} deleted", "Espacio de trabajo {0} eliminado");
		m.put("Workspaces", "Espacios de Trabajo");
		m.put("Workspaces at this commit", "Espacios de trabajo en este commit");
		m.put("Workspaces at this tag", "Espacios de trabajo en esta etiqueta");
		m.put("Workspaces created by this provisioner have same privilege as OneDev process.\nUse '**', '*' or '?' for <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>.\nMultiple projects should be separated by space.<br>\n<b class='text-danger'>WARNING</b>: Workspaces created by this provisioner have same privilege as OneDev process.\nPlease make sure that only trusted projects can use this provisioner", 
			"Los espacios de trabajo creados por este aprovisionador tienen el mismo privilegio que el proceso de OneDev.\nUsa '**', '*' o '?' para <a href='https://docs.onedev.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>.\nMúltiples proyectos deben estar separados por espacio.<br>\n<b class='text-danger'>ADVERTENCIA</b>: Los espacios de trabajo creados por este aprovisionador tienen el mismo privilegio que el proceso de OneDev.\nPor favor, asegúrate de que solo proyectos confiables puedan usar este aprovisionador.");
		m.put("Workspaces on source branch", "Espacios de trabajo en la rama de origen");
		m.put("Workspaces on this branch", "Espacios de trabajo en esta rama");
		m.put("Workspaces on this issue", "Espacios de trabajo en este problema");
		...
		m.put("You will need to update token at agent side after regeneration. Do you really want to continue?", 
			"Necesitarás actualizar el token en el lado del agente después de regenerarlo. ¿Realmente deseas continuar?");
		...
		m.put("active replica", "réplica activa");
		...
		m.put("branch \"{0}\" is created", "la rama \"{0}\" ha sido creada");
		m.put("branch is created", "la rama ha sido creada");
		...
		m.put("duration", "duración");
		m.put("enclose with ~ to query branch", "encerrar con ~ para consultar rama");
		...
		m.put("may not be empty", "no puede estar vacío");
		m.put("merge commit", "fusionar commit");
		m.put("merged", "fusionado");
		m.put("month:Apr", "Abr");
		m.put("month:Aug", "Ago");
		m.put("month:Dec", "Dic");
		...
		m.put("outdated replica", "réplica desactualizada");
		m.put("pack", "paquete");
		m.put("package", "paquete");
		m.put("packages", "paquetes");
		...
		m.put("pull request to any branch is opened or updated", "se abre o actualiza una solicitud de extracción a cualquier rama");
		...
		m.put("pull request to branches \"{0}\" is opened or updated", "se abre o actualiza una solicitud de extracción a las ramas \"{0}\"");
		m.put("pull request {0}", "solicitud de extracción {0}");
		m.put("pull requests", "solicitudes de extracción");
		...
		m.put("represents the <a href='https://code.onedev.io/onedev/server/~files/main/server-core/src/main/java/io/onedev/server/model/Workspace.java' target='_blank'>workspace</a> object to be notified", 
			"representa el objeto <a href='https://code.onedev.io/onedev/server/~files/main/server-core/src/main/java/io/onedev/server/model/Workspace.java' target='_blank'>espacio de trabajo</a> a ser notificado");
		...
		m.put("specify issue number", "especificar número de problema");
		m.put("specify pull request number", "especificar número de solicitud de extracción");
		m.put("state of an issue is transited", "el estado de un problema es transitado");
		m.put("step template", "plantilla de paso");
		m.put("submit", "enviar");
		...
		m.put("tmux Executable", "Ejecutable de tmux");
		...
		m.put("type", "tipo");
		m.put("up to date replica", "réplica actualizada");
