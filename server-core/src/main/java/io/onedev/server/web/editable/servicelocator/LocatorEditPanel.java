...
abstract class LocatorEditPanel extends Panel implements CISpecAware, JobAware {
	...
	public LocatorEditPanel(String id, List<ServiceLocator> locators, int locatorIndex) {
		super(id);
	...
	protected void onInitialize() {
		...
		form.add(new AjaxLink<Void>("close") {
			...
			protected void updateAjaxAttributes(AjaxRequestAttributes attributes) {
				...
				attributes.getAjaxCallListeners().add(new ConfirmLeaveListener(LocatorEditPanel.this));
			}
