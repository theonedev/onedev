...
public abstract class StateTransitionListPanel extends Panel {
	...
	public StateTransitionListPanel(String id) {
		super(id);
	}
			...
			protected Component newContent(String id, ModalPanel modal) {
				return new TransitionEditPanel(id, transitionIndex, transition) {
					...
					protected void onSave(AjaxRequestTarget target, int transitionIndex, TransitionSpec transition) {
						StateTransitionListPanel.this.onSave(target, transitionIndex, transition);
	...
	protected void onInitialize() {
		...
		columns.add(new AbstractColumn<>(Model.of("")) {
			...
			public void populateItem(Item<ICellPopulator<TransitionSpec>> cellItem, String componentId, IModel<TransitionSpec> rowModel) {
				...
				Fragment fragment = new Fragment(componentId, "descriptionFrag", StateTransitionListPanel.this);
		...
		columns.add(new AbstractColumn<>(Model.of("")) {
			...
			public void populateItem(Item<ICellPopulator<TransitionSpec>> cellItem, String componentId, IModel<TransitionSpec> rowModel) {
				...
				Fragment fragment = new Fragment(componentId, "actionColumnFrag", StateTransitionListPanel.this);
				...
				fragment.add(new AjaxLink<Void>("delete") {
					...
					public void onClick(AjaxRequestTarget target) {
						onDelete(target, transitionIndex);
						target.add(transitionsTable);
					}
		...
		transitionsTable.add(new SortBehavior() {
			...
			protected void onSort(AjaxRequestTarget target, SortPosition from, SortPosition to) {
				onReorder(target, from.getItemIndex(), to.getItemIndex());
				target.add(transitionsTable);
			}
	...
	protected abstract List<TransitionSpec> getTransitions();
	
	protected abstract void onSave(AjaxRequestTarget target, int transitionIndex, TransitionSpec transition);
	
	protected abstract void onDelete(AjaxRequestTarget target, int transitionIndex);
	
	protected abstract void onReorder(AjaxRequestTarget target, int fromIndex, int toIndex);
