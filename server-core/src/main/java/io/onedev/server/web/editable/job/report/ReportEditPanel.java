...
abstract class ReportEditPanel extends Panel implements BuildSpecAware, JobAware {

	private final List<JobReport> reports;
	
	private final int reportIndex;
	
	public ReportEditPanel(String id, List<JobReport> reports, int reportIndex) {
		super(id);
	...
	protected void onInitialize() {
		...
		form.add(new AjaxLink<Void>("close") {
			...
			protected void updateAjaxAttributes(AjaxRequestAttributes attributes) {
				...
				attributes.getAjaxCallListeners().add(new ConfirmLeaveListener(ReportEditPanel.this));
			}
