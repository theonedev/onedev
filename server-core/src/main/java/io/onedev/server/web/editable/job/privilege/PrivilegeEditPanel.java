...
abstract class PrivilegeEditPanel extends Panel {

	private final List<JobPrivilege> privileges;
	
	private final int privilegeIndex;
	
	public PrivilegeEditPanel(String id, List<JobPrivilege> privileges, int privilegeIndex) {
		super(id);
	...
	protected void onInitialize() {
		...
		form.add(new AjaxLink<Void>("close") {
			...
			protected void updateAjaxAttributes(AjaxRequestAttributes attributes) {
				...
				attributes.getAjaxCallListeners().add(new ConfirmLeaveListener(PrivilegeEditPanel.this));
			}
