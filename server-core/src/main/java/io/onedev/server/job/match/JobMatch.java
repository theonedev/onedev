...
import io.onedev.server.job.match.JobMatchParser.AndCriteriaContext;
import io.onedev.server.job.match.JobMatchParser.CriteriaContext;
import io.onedev.server.job.match.JobMatchParser.FieldOperatorValueCriteriaContext;
import io.onedev.server.job.match.JobMatchParser.JobMatchContext;
import io.onedev.server.job.match.JobMatchParser.NotCriteriaContext;
import io.onedev.server.job.match.JobMatchParser.OperatorValueCriteriaContext;
import io.onedev.server.job.match.JobMatchParser.OrCriteriaContext;
import io.onedev.server.job.match.JobMatchParser.ParensCriteriaContext;
