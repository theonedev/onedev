...
public class EEClusterManager extends DefaultClusterManager {
	...
	@Inject
	public EEClusterManager(ServerConfig serverConfig, PersistenceManager persistenceManager,
							SettingManager settingManager, ListenerRegistry listenerRegistry, 
							HibernateConfig hibernateConfig) {
		super(serverConfig, persistenceManager, listenerRegistry, hibernateConfig);
