...
import static io.onedev.server.search.FieldConstants.BLOB_HASH;
import static io.onedev.server.search.FieldConstants.BLOB_INDEX_VERSION;
import static io.onedev.server.search.FieldConstants.BLOB_NAME;
import static io.onedev.server.search.FieldConstants.BLOB_PATH;
import static io.onedev.server.search.FieldConstants.BLOB_PRIMARY_SYMBOLS;
import static io.onedev.server.search.FieldConstants.BLOB_SECONDARY_SYMBOLS;
import static io.onedev.server.search.FieldConstants.BLOB_SYMBOL_LIST;
import static io.onedev.server.search.FieldConstants.BLOB_TEXT;
import static io.onedev.server.search.FieldConstants.COMMIT_HASH;
import static io.onedev.server.search.FieldConstants.COMMIT_INDEX_VERSION;
import static io.onedev.server.search.FieldConstants.LAST_COMMIT;
import static io.onedev.server.search.FieldConstants.LAST_COMMIT_HASH;
import static io.onedev.server.search.FieldConstants.LAST_COMMIT_INDEX_VERSION;
import static io.onedev.server.search.FieldConstants.META;
import static io.onedev.server.search.IndexConstants.MAX_INDEXABLE_SIZE;
import static io.onedev.server.search.IndexConstants.NGRAM_SIZE;
