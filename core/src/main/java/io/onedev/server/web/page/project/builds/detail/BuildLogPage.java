...
import io.onedev.server.web.stream.BuildLogStreamResource;
...
public class BuildLogPage extends BuildDetailPage {
	...
	public Component renderOptions(String componentId) {
		...
		fragment.add(new ResourceLink<Void>("download", new BuildLogStreamResourceReference(), 
				BuildLogStreamResource.paramsOf(projectModel.getObject(), getBuild().getNumber())));
		return fragment;
	}
}
