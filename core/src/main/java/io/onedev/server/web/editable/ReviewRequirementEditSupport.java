...
import io.onedev.server.web.component.review.ReviewRequirementAssistBehavior;
				...
				public PropertyEditor<String> renderForEdit(String componentId, IModel<String> model) {
		        	return new StringPropertyEditor(componentId, descriptor, model) {
						...
						protected InputAssistBehavior getInputAssistBehavior() {
							return new ReviewRequirementAssistBehavior(new AbstractReadOnlyModel<Project>() {
