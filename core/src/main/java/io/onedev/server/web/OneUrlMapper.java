...
public class OneUrlMapper extends CompoundRequestMapper {
	...
	private void addProjectPages() {
		...
		add(new OnePageMapper("projects/${project}/issue-boards/edit/${board}", BoardEditPage.class));
		add(new OnePageMapper("projects/${project}/issue-boards/new", NewBoardPage.class));
		...
		add(new OnePageMapper("projects/${project}/issues/${issue}/fix-commits", FixCommitsPage.class));
		add(new OnePageMapper("projects/${project}/issues/${issue}/fix-builds", FixBuildsPage.class));
		add(new OnePageMapper("projects/${project}/issues/${issue}/pulls", ReviewRequestsPage.class));
