...
public abstract class DependencyEditPanel extends Panel {
	...
	public DependencyEditPanel(String id, List<DependencySpec> dependencies, int dependencyIndex) {
		super(id);
	...
	protected void onInitialize() {
		...
		form.add(new AjaxButton("save") {
			...
			protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
				...
				if (dependencyIndex != -1) { 
					DependencySpec oldDependency = dependencies.get(dependencyIndex);
	...
	private DependencySpec getDependency(String job) {
	...
	public abstract JobSpec getBelongingJob();
