...
@Singleton
public class DefaultWebHookManager {

	private static final Logger logger = LoggerFactory.getLogger(DefaultWebHookManager.class);
	...
	@Inject
	public DefaultWebHookManager(ObjectMapper mapper, ExecutorService executor) {
