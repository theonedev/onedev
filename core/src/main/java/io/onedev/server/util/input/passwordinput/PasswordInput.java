package io.onedev.server.util.input.passwordinput;
...
import io.onedev.server.util.input.passwordinput.defaultvalueprovider.DefaultValueProvider;

@Editable(order=500, name=Input.PASSWORD)
