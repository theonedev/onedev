package io.onedev.server.util.input.userchoiceinput;
...
import io.onedev.server.util.input.userchoiceinput.defaultvalueprovider.DefaultValueProvider;
...
@Editable(order=150, name=Input.USER_CHOICE)
public class UserChoiceInput extends Input {
