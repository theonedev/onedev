package io.onedev.server.util.input.usermultichoiceinput;
...
import io.onedev.server.util.input.usermultichoiceinput.defaultvalueprovider.DefaultValueProvider;
import io.onedev.server.util.input.userchoiceprovider.ChoiceProvider;
import io.onedev.server.util.input.userchoiceprovider.ProjectReaders;
import io.onedev.utils.StringUtils;

@Editable(order=151, name=Input.USER_MULTI_CHOICE)
public class UserMultiChoiceInput extends Input {
