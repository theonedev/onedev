package io.onedev.server.util.input.groupmultichoiceinput.defaultvalueprovider;
...
public class ScriptingDefaultValue implements DefaultValueProvider {
	...
	@Editable(description="Groovy script to be evaluated. It should return list of group name. "
