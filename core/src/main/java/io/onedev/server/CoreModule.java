...
import io.onedev.server.entitymanager.impl.DefaultBuild2Manager;
...
import io.onedev.server.entitymanager.impl.DefaultConfigurationManager;
...
import io.onedev.server.entitymanager.impl.DefaultIssueFieldEntityManager;
...
import io.onedev.server.storage.DefaultAttachmentManager;
...
public class CoreModule extends AbstractPluginModule {
	...
	protected void configure() {
		...
		bind(Build2Manager.class).to(DefaultBuild2Manager.class);
