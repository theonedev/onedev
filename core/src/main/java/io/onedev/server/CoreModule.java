...
import io.onedev.server.manager.impl.DefaultTeamManager;
import io.onedev.server.manager.impl.DefaultIssueActionManager;
...
import io.onedev.server.manager.impl.DefaultIssueInfoManager;
...
import io.onedev.server.manager.impl.DefaultPullRequestActionManager;
...
public class CoreModule extends AbstractPluginModule {
	...
	protected void configure() {
		...
		bind(PullRequestActionManager.class).to(DefaultPullRequestActionManager.class);
		...
		bind(IssueActionManager.class).to(DefaultIssueActionManager.class);
