...
import io.onedev.server.manager.impl.DefaultIssueBoardManager;
...
import io.onedev.server.manager.impl.DefaultTaskManager;
...
public class CoreModule extends AbstractPluginModule {
	...
	protected void configure() {
		...
		bind(IssueBoardManager.class).to(DefaultIssueBoardManager.class);
