...
import static io.onedev.server.codesearch.FieldConstants.BLOB_HASH;
import static io.onedev.server.codesearch.FieldConstants.BLOB_INDEX_VERSION;
import static io.onedev.server.codesearch.FieldConstants.BLOB_NAME;
import static io.onedev.server.codesearch.FieldConstants.BLOB_PATH;
import static io.onedev.server.codesearch.FieldConstants.BLOB_PRIMARY_SYMBOLS;
import static io.onedev.server.codesearch.FieldConstants.BLOB_SECONDARY_SYMBOLS;
import static io.onedev.server.codesearch.FieldConstants.BLOB_SYMBOL_LIST;
import static io.onedev.server.codesearch.FieldConstants.BLOB_TEXT;
import static io.onedev.server.codesearch.FieldConstants.COMMIT_HASH;
import static io.onedev.server.codesearch.FieldConstants.COMMIT_INDEX_VERSION;
import static io.onedev.server.codesearch.FieldConstants.LAST_COMMIT;
import static io.onedev.server.codesearch.FieldConstants.LAST_COMMIT_HASH;
import static io.onedev.server.codesearch.FieldConstants.LAST_COMMIT_INDEX_VERSION;
import static io.onedev.server.codesearch.FieldConstants.META;
import static io.onedev.server.codesearch.IndexConstants.MAX_INDEXABLE_SIZE;
import static io.onedev.server.codesearch.IndexConstants.NGRAM_SIZE;
