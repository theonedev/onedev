...
public class CreateDateCriteria extends EntityCriteria<CodeComment> {
	...
	public Predicate getPredicate(Project project, QueryBuildContext<CodeComment> context) {
		Path<Date> attribute = context.getRoot().get(CodeComment.FIELD_PATHS.get(CodeComment.FIELD_CREATE_DATE));
	...
	public String toString() {
		return CodeCommentQuery.quote(CodeComment.FIELD_CREATE_DATE) + " " + CodeCommentQuery.getRuleName(operator) + " " + CodeCommentQuery.quote(rawValue);
	}
