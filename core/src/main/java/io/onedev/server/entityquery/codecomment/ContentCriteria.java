...
public class ContentCriteria extends EntityCriteria<CodeComment> {
	...
	public Predicate getPredicate(Project project, QueryBuildContext<CodeComment> context) {
		Path<String> attribute = context.getRoot().get(CodeComment.FIELD_PATHS.get(CodeComment.FIELD_CONTENT));
	...
	public String toString() {
		return CodeCommentQuery.quote(CodeComment.FIELD_CONTENT) + " " + CodeCommentQuery.getRuleName(CodeCommentQueryLexer.Contains) + " " + CodeCommentQuery.quote(value);
	}
